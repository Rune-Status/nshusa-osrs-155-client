public class class72 extends class163 {
	...
	static final void method1164() {
		for (Projectile var0 = (Projectile) Client.projectiles
				.getFront(); var0 != null; var0 = (Projectile) Client.projectiles.getNext()) {
				...
				if (Client.gameCycle >= var0.startTime) {
					if (var0.interacting > 0) {
						...
						if (var1 != null && var1.x >= 0 && var1.x < 13312 && var1.y >= 0 && var1.y < 13312) {
							var0.method1817(var1.x, var1.y,
									CacheFile.getTileHeight(var1.x, var1.y, var0.floor) - var0.endHeight,
									Client.gameCycle);
						}
					}
					...
					if (var0.interacting < 0) {
						...
						if (var3 != null && var3.x >= 0 && var3.x < 13312 && var3.y >= 0 && var3.y < 13312) {
							var0.method1817(var3.x, var3.y,
									CacheFile.getTileHeight(var3.x, var3.y, var0.floor) - var0.endHeight,
									Client.gameCycle);
						}
					}

					var0.method1818(Client.field1122);
					class8.region.method2768(class5.plane, (int) var0.x, (int) var0.velocityZ, (int) var0.z, 60, var0,
							var0.rotationX, -1, false);
				}
			} else {
				var0.unlink();
			}
	...
	static int method1165(int var0, Script var1, boolean var2) {
		if (var0 == 3200) {
			...
			WidgetNode.method1140(class81.intStack[class81.intStackSize], class81.intStack[class81.intStackSize + 1],
					class81.intStack[class81.intStackSize + 2]);
			return 1;
		} else {
			int var3;
			if (var0 != 3201) {
