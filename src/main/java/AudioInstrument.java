...
public class AudioInstrument {
	...
	final void decode(Buffer var1) {
		...
		if (var2 != 0) {
			...
			this.field1718 = new AudioEnvelope();
			this.field1718.decode(var1);
		}
	...
	final int[] synthesize(int var1, int var2) {
		class183.method3557(samples, 0, var1);
		if (var2 < 10) {
			return samples;
		} else {
			...
			for (var11 = 0; var11 < 5; ++var11) {
				if (this.oscillatorVolume[var11] != 0) {
					...
					pitchSteps[var11] = (int) ((double) (this.pitch.end - this.pitch.start) * 32.768D
							* Math.pow(1.0057929410678534D, (double) this.oscillatorPitch[var11]) / var3);
			...
			for (var11 = 0; var11 < var1; ++var11) {
				...
				for (var14 = 0; var14 < 5; ++var14) {
					if (this.oscillatorVolume[var14] != 0) {
						...
						if (var15 < var1) {
							samples[var15] += this.evaluateWave(phases[var14], volumeSteps[var14] * var13 >> 15,
									this.pitch.form);
				...
				if (var1 >= var12 + var13) {
					...
					while (var14 < var15) {
						...
						for (var17 = 0; var17 < var12; ++var17) {
							var16 += (int) ((long) samples[var14 + var12 - 1 - var17]
									* (long) SoundEffect3.coefficients[0][var17] >> 16);
						}

						for (var17 = 0; var17 < var14; ++var17) {
							var16 -= (int) ((long) samples[var14 - 1 - var17]
									* (long) SoundEffect3.coefficients[1][var17] >> 16);
						}
						...
						while (var14 < var15) {
							...
							for (var18 = 0; var18 < var12; ++var18) {
								var17 += (int) ((long) samples[var14 + var12 - 1 - var18]
										* (long) SoundEffect3.coefficients[0][var18] >> 16);
							}

							for (var18 = 0; var18 < var13; ++var18) {
								var17 -= (int) ((long) samples[var14 - 1 - var18]
										* (long) SoundEffect3.coefficients[1][var18] >> 16);
							}
	...
	final int evaluateWave(int var1, int var2, int var3) {
		return var3 == 1 ? ((var1 & 32767) < 16384 ? var2 : -var2)
				: (var3 == 2 ? SINE[var1 & 32767] * var2 >> 14
