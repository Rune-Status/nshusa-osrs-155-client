...
public class class23 {
		...
		while (true) {
			if (Client.secretPacketBuffer2.bitsAvail(Client.packetLength) >= 27) {
				...
				if (var1 != 32767) {
					...
					var3.method1754(AbstractByteBuffer.localPlayer.pathX[0] + var4,
							AbstractByteBuffer.localPlayer.pathY[0] + var8, var5 == 1);
					continue;
				}
			}
	...
	public static final SpritePixels createSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		...
		if (var21 == null) {
			...
			var21.method2594();
			var21.method2607(0, var9.yan2d, var9.zan2d, var9.xan2d, var9.offsetX2d,
					var21.modelHeight / 2 + var17 + var9.offsetY2d, var18 + var9.offsetY2d);
			if (var9.notedId != -1) {
				var22.method5172(0, 0);
			}
