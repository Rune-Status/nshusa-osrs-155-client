final class class2 implements class0 {
	...
	static IndexedSprite method8(boolean var0, boolean var1) {
		return var0 ? (var1 ? class37.field527 : class90.field1415)
				: (var1 ? class29.field431 : TextureProvider.field1758);
	}
	...
	static void method5(Player var0, int var1, int var2) {
		if (var0.animation == var1 && var1 != -1) {
			...
			if (var3 == 2) {
				...
				|| class204.getAnimation(var1).forcedPriority >= class204.getAnimation(var0.animation).forcedPriority) {
			var0.animation = var1;
			var0.actionFrame = 0;
			var0.field1207 = 0;
			var0.actionAnimationDisable = var2;
