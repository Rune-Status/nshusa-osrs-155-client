public class Track1 extends Node {
	...
	Track1(Buffer var1) {
		...
		var1.offset += var5 * 3;
		this.field2609 = new byte[var4];
		Buffer var51 = new Buffer(this.field2609);
		...
		label222: for (int var60 = 0; var60 < var2; ++var60) {
	...
	void method4030() {
		if (this.field2608 == null) {
			this.field2608 = new HashTable(16);
			int[] var1 = new int[16];
			int[] var2 = new int[16];
			var2[9] = 128;
			var1[9] = 128;
			class206 var4 = new class206(this.field2609);
			int var5 = var4.method3948();

			int var6;
			for (var6 = 0; var6 < var5; ++var6) {
				var4.method3971(var6);
				var4.method3961(var6);
				var4.method3938(var6);
			}

			label53: do {
				while (true) {
					var6 = var4.method3945();
					int var7 = var4.field2586[var6];

					while (var7 == var4.field2586[var6]) {
						var4.method3971(var6);
						int var8 = var4.method3941(var6);
						if (var8 == 1) {
							var4.method3939();
							var4.method3938(var6);
							continue label53;
						...
						if (var9 == 144) {
							...
							if (var12 > 0) {
								...
								class199 var14 = (class199) this.field2608.get((long) var13);
								if (var14 == null) {
									var14 = new class199(new byte[128]);
									this.field2608.put(var14, (long) var13);
								}

								var14.field2500[var11] = 1;
							}
						}
