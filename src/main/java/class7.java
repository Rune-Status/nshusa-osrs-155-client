public class class7 {
	...
	static void method35(Player var0, boolean var1) {
		if (var0 != null && var0.hasConfig() && !var0.hidden) {
			...
			var0.field901 = false;
			if ((Client.lowMemory && class94.field1485 > 50 || class94.field1485 > 200) && var1
			...
			if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) {
				if (var0.model != null && Client.gameCycle >= var0.field891 && Client.gameCycle < var0.field892) {
					...
					class8.region.method2811(class5.plane, var0.x, var0.y, var0.field890, 60, var0, var0.angle, var2,
							var0.field904, var0.field898, var0.field883, var0.field900);
				} else {
					...
					var0.field890 = CacheFile.getTileHeight(var0.x, var0.y, class5.plane);
					class8.region.method2768(class5.plane, var0.x, var0.y, var0.field890, 60, var0, var0.angle, var2,
							var0.field1210);
				}
			}
		}
