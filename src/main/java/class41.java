...
public final class class41 {
			...
			for (int var17 = 0; var17 < var9; ++var17) {
				for (int var18 = 0; var18 < var10; ++var18) {
					if (this.field575[var17][var18] == null) {
						this.field575[var17][var18] = new class34(this.field572.method316() + var17,
								this.field572.method333() + var18, this.field572.method274(), this.field578);
	...
	public List method546(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9,
			int var10) {
		...
		if (!this.field588) {
			...
			for (int var17 = var12.field436; var17 < var12.field434 + var12.field436; ++var17) {
				for (int var18 = var12.field429; var18 < var12.field429 + var12.field430; ++var18) {
					List var19 = this.field575[var17][var18].method376(
							var5 + var14 * (this.field575[var17][var18].field497 * 64 - var15) / 64,
							var8 + var6 - var14 * (this.field575[var17][var18].field498 * 64 - var16 + 64) / 64, var14,
							var9, var10);
					if (!var19.isEmpty()) {
						var11.addAll(var19);
					}
	...
	public final void method543(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (var17 = var13.field436; var17 < var13.field434 + var13.field436; ++var17) {
			for (var18 = var13.field429; var18 < var13.field430 + var13.field429; ++var18) {
				...
				this.field575[var17][var18].method345(var15, (class46) this.field573.get(Integer.valueOf(var15)), var22,
						this.field587);
			}
		}
		...
		for (int var20 = var13.field436; var20 < var13.field434 + var13.field436; ++var20) {
			for (int var21 = var13.field429; var21 < var13.field430 + var13.field429; ++var21) {
				this.field575[var20][var21].method340(
						var5 + (this.field575[var20][var21].field497 * 64 - var18) * var17 / 64,
						var8 - var17 * (this.field575[var20][var21].field498 * 64 - var19 + 64) / 64, var17);
			}
		}

	}

	public final void method540(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
		...
		for (var19 = var14.field436; var19 < var14.field434 + var14.field436; ++var19) {
			for (var20 = var14.field429; var20 < var14.field429 + var14.field430; ++var20) {
				...
				this.field575[var19][var20].method346(
						(this.field575[var19][var20].field497 * 64 - var17) * var16 / 64 + var5,
						var8 - (this.field575[var19][var20].field498 * 64 - var18 + 64) * var16 / 64, var16, var9);
			}
		}
	...
	static final void method592() {
		...
		if (Client.packetType == Opcodes.PACKET_SERVER_19) {
			if (Client.RUNELITE_PACKET) {
				...
				var2 = var0 & 3;
				var3 = Client.field987[var1];
				var29 = Client.secretPacketBuffer2.readUByteS();
			}
			...
			if (Client.packetType == Opcodes.PACKET_SERVER_195) {
				...
				if (Client.packetType == Opcodes.PACKET_SERVER_23) {
					...
					if (var1 >= 0 && var2 >= 0 && var1 < 103 && var2 < 103) {
						if (var32 == 0) {
							...
							if (var34 != null) {
								...
								if (var30 == 2) {
									var34.renderable1 = new DynamicObject(var9, 2, var31 + 4, class5.plane, var1, var2,
											var3, false, var34.renderable1);
									var34.renderable2 = new DynamicObject(var9, 2, var31 + 1 & 3, class5.plane, var1,
											var2, var3, false, var34.renderable2);
								} else {
									var34.renderable1 = new DynamicObject(var9, var30, var31, class5.plane, var1, var2,
											var3, false, var34.renderable1);
								}
							}
						}
						...
						if (var32 == 1) {
							...
							if (var40 != null) {
								...
								if (var30 != 4 && var30 != 5) {
									if (var30 == 6) {
										var40.renderable1 = new DynamicObject(var9, 4, var31 + 4, class5.plane, var1,
												var2, var3, false, var40.renderable1);
									} else if (var30 == 7) {
										var40.renderable1 = new DynamicObject(var9, 4, (var31 + 2 & 3) + 4,
												class5.plane, var1, var2, var3, false, var40.renderable1);
									} else if (var30 == 8) {
										var40.renderable1 = new DynamicObject(var9, 4, var31 + 4, class5.plane, var1,
												var2, var3, false, var40.renderable1);
										var40.renderable2 = new DynamicObject(var9, 4, (var31 + 2 & 3) + 4,
												class5.plane, var1, var2, var3, false, var40.renderable2);
									}
								} else {
									var40.renderable1 = new DynamicObject(var9, 4, var31, class5.plane, var1, var2,
											var3, false, var40.renderable1);
								}
							}
						}
						...
						if (var32 == 2) {
							...
							if (var41 != null) {
								var41.renderable = new DynamicObject(var41.hash >> 14 & 32767, var30, var31,
										class5.plane, var1, var2, var3, false, var41.renderable);
							}
						}
						...
						if (var32 == 3) {
							...
							if (var42 != null) {
								var42.renderable = new DynamicObject(var42.hash >> 14 & 32767, 22, var31, class5.plane,
										var1, var2, var3, false, var42.renderable);
							}
						}
					}
					...
					if (Client.RUNELITE_PACKET) {
						...
						var0 = Client.secretPacketBuffer2.readUByteN();
						var1 = (var0 >> 4 & 7) + class31.field453;
						var2 = (var0 & 7) + Actor.field1270;
					...
					if (Client.packetType == Opcodes.PACKET_SERVER_57) {
						...
						if (var1 >= 0 && var2 >= 0 && var1 < 104 && var2 < 104) {
							var8 = var30 + 1;
							if (AbstractByteBuffer.localPlayer.pathX[0] >= var1 - var8
									&& AbstractByteBuffer.localPlayer.pathX[0] <= var1 + var8
									&& AbstractByteBuffer.localPlayer.pathY[0] >= var2 - var8
									&& AbstractByteBuffer.localPlayer.pathY[0] <= var8 + var2 && Client.field1114 != 0
									&& var31 > 0 && Client.field1154 < 50) {
						...
						if (var1 >= 0 && var2 >= 0 && var1 < 104 && var2 < 104) {
							var1 = var1 * 128 + 64;
							var2 = var2 * 128 + 64;
							GraphicsObject var38 = new GraphicsObject(var3, class5.plane, var1, var2,
									CacheFile.getTileHeight(var1, var2, class5.plane) - var29, var30, Client.gameCycle);
						...
						if (Client.packetType == Opcodes.PACKET_SERVER_163) {
							...
							if (Client.RUNELITE_PACKET) {
								...
								var11 = Client.secretPacketBuffer2.readUByteS();
							}
							...
							if (var15 != null) {
								...
								int var24 = var23[var20][var21] + var23[var19][var21] + var23[var19][var22]
										+ var23[var20][var22] >> 2;
								int var25 = (var32 << 7) + (var17 << 6);
								int var26 = (var8 << 7) + (var18 << 6);
								Model var27 = var16.method4614(var12, var33, var23, var25, var24, var26);
								if (var27 != null) {
									class205.method3930(class5.plane, var32, var8, var14, -1, 0, 0, var29 + 1,
											var10 + 1);
							...
							if (var1 >= 0 && var2 >= 0 && var1 < 104 && var2 < 104 && var3 >= 0 && var29 >= 0
									&& var3 < 104 && var29 < 104 && var31 != '\uffff') {
								var1 = var1 * 128 + 64;
								var2 = 64 + var2 * 128;
								var3 = 64 + var3 * 128;
								var29 = var29 * 128 + 64;
								Projectile var13 = new Projectile(var31, class5.plane, var1, var2,
										CacheFile.getTileHeight(var1, var2, class5.plane) - var32,
										var9 + Client.gameCycle, var10 + Client.gameCycle, var11, var12, var30, var8);
								var13.method1817(var3, var29, CacheFile.getTileHeight(var3, var29, class5.plane) - var8,
										var9 + Client.gameCycle);
