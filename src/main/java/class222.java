public class class222 {
	...
	static {
		field2843 = new boolean[] { true, true, true, true, true, true, true, true, true, true, true, true, true, true,
		...
		if (var0.indexOf("%") != -1) {
			...
			for (var2 = 1; var2 <= 5; ++var2) {
				while (true) {
					...
					var0 = var0.substring(0, var3) + Varcs.method1895(ScriptVarType.method27(var1, var2 - 1))
