public final class IndexedSprite extends Rasterizer2D {
	...
	public void method5147(int var1, int var2) {
		var1 += this.offsetX;
		var2 += this.offsetY;
		...
		if (var6 > 0 && var5 > 0) {
			method5148(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
		}
	}

	public void method5149(int var1, int var2, int var3, int var4) {
		...
		method5150(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var7, var8, var13, var14, var3, var4, var11,
				var12, var5);
	}

	public void method5158(int var1, int var2, int var3) {
	...
	static void method5148(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7,
			int var8) {
		int var9 = -(var5 >> 2);
		var5 = -(var5 & 3);
	...
	static void method5150(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7,
