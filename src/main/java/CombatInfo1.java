public class CombatInfo1 extends Node {
	...
	static final int method1607() {
		if (class23.preferences.hideRoofs) {
			...
			if (AbstractByteBuffer.localPlayer.x >= 0 && AbstractByteBuffer.localPlayer.y >= 0
					&& AbstractByteBuffer.localPlayer.x < 13312 && AbstractByteBuffer.localPlayer.y < 13312) {
				if ((class61.tileSettings[class5.plane][AbstractByteBuffer.localPlayer.x >> 7][AbstractByteBuffer.localPlayer.y >> 7]
						& 4) != 0) {
					var0 = class5.plane;
				}
