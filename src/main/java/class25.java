	...
	static void method173(Font var0, Font var1) {
		...
		if (ClanMember.field916 != null) {
			...
			for (var14 = 0; var14 < World.worldCount; ++var14) {
				...
				if (MouseInput.field745 >= var11 && MouseInput.field746 >= var10 && MouseInput.field745 < var11 + var21
						&& MouseInput.field746 < var10 + var22 && var16) {
			...
			if (var13) {
				...
				Rasterizer2D.method5129(MouseInput.field745 - var14 / 2, MouseInput.field746 + 20 + 5, var14, var20,
						16777120);
				Rasterizer2D.drawRectangle(MouseInput.field745 - var14 / 2, MouseInput.field746 + 20 + 5, var14, var20,
						0);
				var1.method4843(class138.worldList[class90.field1429].activity, MouseInput.field745,
						MouseInput.field746 + var1.verticalSpace + 20 + 5 + 4, 0, -1);
			}
		}
