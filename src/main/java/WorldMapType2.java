...
public class WorldMapType2 implements WorldMapSectionBase {
	...
	public boolean vmethod725(int var1, int var2, int var3) {
		return var1 >= this.field538 && var1 < this.field540 + this.field538
				? var2 >> 6 == this.field535 && var3 >> 6 == this.field536
				: false;
	}
	...
	public int[] vmethod741(int var1, int var2, int var3) {
		if (!this.vmethod725(var1, var2, var3)) {
			...
			int[] var4 = new int[] { var2 + (this.field537 * 64 - this.field535 * 64),
					var3 + (this.field534 * 64 - this.field536 * 64) };
			return var4;
		}
	}
	...
	static final void gameDraw(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7,
			int var8) {
				...
				if (!var10.hasScript || !Script.method1926(var10)) {
					...
					if (!var10.hasScript || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (Client.displayFps) {
									var13 += 15;
									class20.font_p12full.method4842("Fps:" + GameEngine.FPS, var12 + var10.width, var13,
											16776960, -1);
									var13 += 15;
									...
									class20.font_p12full.method4842("Mem:" + var20 + "k", var12 + var10.width, var13,
											var21, -1);
									var13 += 15;
								}
								continue;
							...
							if (var10.contentType == 1400) {
								GameObject.renderOverview.extractWorldmap(var12, var13, var10.width, var10.height,
										Client.gameCycle);
							}
						...
						if (var10.type == 0) {
							...
							gameDraw(var0, var10.id, var15, var16, var17, var18, var12 - var10.scrollX,
									var13 - var10.scrollY, var11);
							if (var10.children != null) {
								gameDraw(var10.children, var10.id, var15, var16, var17, var18, var12 - var10.scrollX,
										var13 - var10.scrollY, var11);
							}
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
									...
									for (var20 = 0; var20 < var10.field2670; ++var20) {
										for (var21 = 0; var21 < var10.originalWidth; ++var21) {
											...
											if (var10.itemIds[var19] <= 0) {
												...
												if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3
														&& var23 < var5
														|| var10 == ClanMember.field915 && var19 == Client.field1025) {
													SpritePixels var27;
													if (Client.itemSelectionState == 1
															&& var19 == class39.selectedItemIndex
															&& var10.id == class25.field371) {
														var27 = class23.createSprite(var26, var10.itemQuantities[var19],
																2, 0, 2, false);
													} else {
														var27 = class23.createSprite(var26, var10.itemQuantities[var19],
																1, 3153952, 2, false);
													...
													if (var27 != null) {
														if (var10 == ClanMember.field915 && var19 == Client.field1025) {
															...
															if (var1 != -1) {
																...
																int var29;
																if (var25 + var23 < Rasterizer2D.drawingAreaTop
																		&& var28.scrollY > 0) {
																	var29 = (Rasterizer2D.drawingAreaTop - var23
																			- var25) * Client.field1122 / 3;
																...
																if (var23 + var25 + 32 > Rasterizer2D.drawingAreaRight
																	...
																	if (var29 > var28.scrollHeight - var28.height
																			- var28.scrollY) {
																		var29 = var28.scrollHeight - var28.height
																				- var28.scrollY;
																	}
														...
														} else if (var10 == SceneTilePaint.field2031
																&& var19 == Client.field1024) {
									...
									if (var10.field2650) {
										...
										case 1:
											Rasterizer2D.method5055(var12, var13, var10.width, var10.height,
													var10.textColor, var10.field2779, 256 - (var10.opacity & 255),
													256 - (var10.field2690 & 255));
											break;
										case 2:
											Rasterizer2D.method5056(var12, var13, var10.width, var10.height,
													var10.textColor, var10.field2779, 256 - (var10.opacity & 255),
													256 - (var10.field2690 & 255));
											break;
										case 3:
											Rasterizer2D.method5057(var12, var13, var10.width, var10.height,
													var10.textColor, var10.field2779, 256 - (var10.opacity & 255),
													256 - (var10.field2690 & 255));
											break;
										case 4:
											Rasterizer2D.method5058(var12, var13, var10.width, var10.height,
													var10.textColor, var10.field2779, 256 - (var10.opacity & 255),
													256 - (var10.field2690 & 255));
											break;
										default:
											if (var14 == 0) {
												...
												Rasterizer2D.fillRectangle(var12, var13, var10.width, var10.height,
														var19, 256 - (var14 & 255));
											}
										}
									} else if (var14 == 0) {
										...
										Rasterizer2D.method5062(var12, var13, var10.width, var10.height, var19,
												256 - (var14 & 255));
									}
								} else {
									Font var39;
									if (var10.type == 4) {
										...
										if (var39 == null) {
											...
											if (var10.hasScript && var10.itemId != -1) {
												...
												if ((var46.isStackable == 1 || var10.itemQuantity != 1)
														&& var10.itemQuantity != -1) {
													var43 = class60.getColTags(16748608) + var43 + "</col>" + " " + 'x'
															+ class20.method147(var10.itemQuantity);
												}
											}
											...
											var39.method4844(var43, var12, var13, var10.width, var10.height, var20,
													var10.textShadowed ? 0 : -1, var10.field2721, var10.field2722,
													var10.field2720);
										}
										...
										if (!var10.hasScript) {
											...
											if (var10.itemId != -1) {
												var40 = class23.createSprite(var10.itemId, var10.itemQuantity,
														var10.borderThickness, var10.sprite2, var10.field2716, false);
											} else {
											...
											if (var40 == null) {
												...
												if (!var10.field2696) {
													...
													if (var10.textureId != 0) {
														var40.method5188(var10.width / 2 + var12,
																var10.height / 2 + var13, var10.textureId, var22);
													} else if (var14 != 0) {
														var40.method5183(var12, var13, var10.width, var10.height,
																256 - (var14 & 255));
													...
													Rasterizer2D.setInnerDrawRegion(var12, var13, var12 + var10.width,
															var13 + var10.height);
													...
													for (var24 = 0; var24 < var22; ++var24) {
														for (var25 = 0; var25 < var23; ++var25) {
															if (var10.textureId != 0) {
																var40.method5188(var20 / 2 + var24 * var20 + var12,
																		var21 / 2 + var13 + var21 * var25,
																		var10.textureId, 4096);
															} else if (var14 != 0) {
																var40.method5181(var12 + var24 * var20,
																		var21 * var25 + var13, 256 - (var14 & 255));
															} else {
																var40.method5172(var12 + var20 * var24,
																		var13 + var21 * var25);
															}
														}
													}
										...
										if (var10.type == 6) {
											...
											if (var10.itemId != -1) {
												...
												if (var10.modelId == 0) {
													var41 = Client.field1179.method4072((Sequence) null, -1,
															(Sequence) null, -1);
												} else {
													var41 = AbstractByteBuffer.localPlayer.getModel();
												}
											} else if (var20 == -1) {
												var41 = var10.method4146((Sequence) null, -1, var36,
														AbstractByteBuffer.localPlayer.composition);
												if (var41 == null && Widget.field2719) {
													class25.method172(var10);
												}
											} else {
												Sequence var47 = class204.getAnimation(var20);
												var41 = var10.method4146(var47, var10.field2776, var36,
														AbstractByteBuffer.localPlayer.composition);
												if (var41 == null && Widget.field2719) {
													class25.method172(var10);
												}
											...
											if (var41 != null) {
												if (!var10.hasScript) {
													var41.method2607(0, var10.rotationZ, 0, var10.rotationX, 0, var23,
															var24);
												} else {
													var41.method2594();
													if (var10.field2715) {
														var41.method2608(0, var10.rotationZ, var10.rotationY,
																var10.rotationX, var10.field2707,
																var22 + var23 + var10.field2708,
																var24 + var10.field2708, var10.modelZoom);
													} else {
														var41.method2607(0, var10.rotationZ, var10.rotationY,
																var10.rotationX, var10.field2707,
																var22 + var23 + var10.field2708,
																var24 + var10.field2708);
													}
												}
											}
												...
												for (var21 = 0; var21 < var10.field2670; ++var21) {
													for (var22 = 0; var22 < var10.originalWidth; ++var22) {
														if (var10.itemIds[var20] > 0) {
															...
															String var33;
															if (var34.isStackable != 1
																	&& var10.itemQuantities[var20] == 1) {
																var33 = class60.getColTags(16748608) + var34.name
																		+ "</col>";
															} else {
																var33 = class60.getColTags(16748608) + var34.name
																		+ "</col>" + " " + 'x' + class20
																				.method147(var10.itemQuantities[var20]);
															}

															var25 = var12 + var22 * (var10.paddingX + 115);
															var26 = (var10.paddingY + 12) * var21 + var13;
															if (var10.field2721 == 0) {
																var39.method4840(var33, var25, var26, var10.textColor,
																		var10.textShadowed ? 0 : -1);
															} else if (var10.field2721 == 1) {
																var39.method4843(var33, var10.width / 2 + var25, var26,
																		var10.textColor, var10.textShadowed ? 0 : -1);
															} else {
																var39.method4842(var33, var25 + var10.width - 1, var26,
																		var10.textColor, var10.textShadowed ? 0 : -1);
															}
														}
											...
											if (var10.type == 8 && var10 == class48.field635
													&& Client.field1064 == Client.field1065) {
												var19 = 0;
												var20 = 0;
												...
												String var44;
												for (var32 = class222.method4189(var32, var10); var32
														.length() > 0; var20 = var20 + var31.verticalSpace + 1) {
												...
												for (var32 = class222.method4189(var32, var10); var32
														.length() > 0; var26 = var26 + var31.verticalSpace + 1) {
											...
											if (var10.type == 9) {
												...
												if (var10.field2702 == 1) {
													...
													ScriptState.method1123(var19, var20, var21, var22, var10.textColor,
															var10.field2702);
												}
											}
										}
			...
			if ((Client.friendCount < 200 || Client.field1035 == 1) && Client.friendCount < 400) {
				...
				if (var1 != null) {
					...
					for (var2 = 0; var2 < Client.ignoreCount; ++var2) {
						...
						if (var4 != null && var4.equals(var1)) {
							MessageNode.sendGameMessage(30, "",
		...
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
			...
			if (var7 != 0) {
				...
				if (var1 == 2) {
					...
					var12 = Occluder.getObjectDefinition(var13);
					if (var2 + var12.sizeX > 103 || var3 + var12.sizeX > 103 || var2 + var12.sizeY > 103
							|| var3 + var12.sizeY > 103) {
						return;
					}

					if (var12.interactType != 0) {
						Client.collisionMaps[var0].removeObject(var2, var3, var12.sizeX, var12.sizeY, var15,
								var12.field3456);
					}
				}
