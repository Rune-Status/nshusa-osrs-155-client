public class Floor1 {
	...
	static boolean[] field1606;

	static final float[] field1601;
	...
	static {
		...
		field1601 = new float[] { 1.0649863E-7F, 1.1341951E-7F, 1.2079015E-7F, 1.2863978E-7F, 1.369995E-7F,
	...
	Floor1() {
		...
		if (var1 != 1) {
			...
			this.field1602 = new int[var5];
			this.field1602[0] = 0;
			this.field1602[1] = 1 << var4;
			var5 = 2;
			...
			for (var9 = 0; var9 < var2; ++var9) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field1602[var5++] = class104.getInt(var4);
				}
			}
			...
			if (xList == null || xList.length < var5) {
				xList = new int[var5];
				yList = new int[var5];
				field1606 = new boolean[var5];
			}

		}
	}

	void method2059(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = xList[var1];
			int var5 = yList[var1];
			boolean var6 = field1606[var1];
			...
			yList[var3] = var5;
			field1606[var3] = var6;
			this.method2059(var1, var3 - 1);
			this.method2059(var3 + 1, var2);
		}
	}

	void method2058(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
		...
		for (int var14 = var1 + 1; var14 < var3; ++var14) {
			...
			var5[var14] *= field1601[var11];
		}

	}

	int method2057(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	boolean decodedFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field1602.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				xList[var3] = this.field1602[var3];
			}

			var3 = RANGES[this.multiplier - 1];
			int var4 = class132.ilog(var3 - 1);
	...
	void computeFloor(float[] var1, int var2) {
		int var3 = this.field1602.length;
		int var4 = RANGES[this.multiplier - 1];
		boolean[] var5 = field1606;
		field1606[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method2077(xList, var6);
			var8 = method2056(xList, var6);
			var9 = this.method2057(xList[var7], yList[var7], xList[var8], yList[var8], xList[var6]);
			var10 = yList[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field1606;
				field1606[var8] = true;
				var14[var7] = true;
				field1606[var6] = true;
				if (var10 >= var13) {
				...
				field1606[var6] = false;
				yList[var6] = var9;
			}
		}

		this.method2059(0, var3 - 1);
		var6 = 0;
		...
		for (var8 = 1; var8 < var3; ++var8) {
			if (field1606[var8]) {
				...
				this.method2058(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	static int method2077(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
