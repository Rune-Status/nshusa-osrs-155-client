public final class PendingSpawn extends Node {
	...
	static void drawLoginScreen(Font var0, Font var1, Font var2, boolean var3) {
		...
		if (class90.worldSelectShown) {
			...
			if (Client.gameState == 0 || Client.gameState == 5) {
				byte var4 = 20;
				var0.method4843("RuneScape is loading - please wait...", class90.loginWindowX + 180, 245 - var4,
						16777215, -1);
				var5 = 253 - var4;
				...
				Rasterizer2D.method5129(class90.loginWindowX + 180 - 150, var5 + 2, class90.loadingBarPercentage * 3,
						30, 9179409);
				Rasterizer2D.method5129(class90.loginWindowX + 180 - 150 + class90.loadingBarPercentage * 3, var5 + 2,
						300 - class90.loadingBarPercentage * 3, 30, 0);
			...
			if (Client.gameState == 20) {
				class90.field1411.method5147(class90.loginWindowX + 180 - class90.field1411.originalWidth / 2,
						271 - class90.field1411.height / 2);
				var26 = 201;
				...
				if (class90.loginIndex != 4) {
					...
					for (var17 = var17; var0.method4918(var17) > var28; var17 = var17.substring(0,
							var17.length() - 1)) {
						;
					}

					var0.method4840(FontTypeFace.appendTags(var17), class90.loginWindowX + 180 - 70, var27, 16777215,
							0);
					var27 += 15;
					var9 = "Password: ";
			...
			if (Client.gameState == 10 || Client.gameState == 11) {
				...
				if (class90.loginIndex == 0) {
					...
					var0.method4840(FontTypeFace.appendTags(var17)
							+ (class90.field1439 == 0 & Client.gameCycle % 40 < 20 ? class60.getColTags(16776960) + "|"
									: ""),
							WorldMapType2.field539 - 70, var27, 16777215, 0);
					var27 += 15;
					var9 = "Password: ";
					var20 = class90.password;
					var13 = var20.length();
					...
					var32 = new String(var14);
					var0.method4840(var9 + var32
							+ (class90.field1439 == 1 & Client.gameCycle % 40 < 20 ? class60.getColTags(16776960) + "|"
									: ""),
							WorldMapType2.field539 - 108, var27, 16777215, 0);
					var27 += 15;
					var26 = 277;
					...
					var26 = 357;
					var1.method4843("Forgotten your password? <col=ffffff>Click here.", WorldMapType2.field539, var26,
							16776960, 0);
				} else if (class90.loginIndex == 3) {
					var26 = 201;
					var0.method4843("Invalid username or password.", class90.loginWindowX + 180, var26, 16776960, 0);
					var27 = var26 + 20;
					var1.method4843("For accounts created after 24th November 2010, please use your",
							class90.loginWindowX + 180, var27, 16776960, 0);
					var27 += 15;
					var1.method4843("email address to login. Otherwise please login with your username.",
							class90.loginWindowX + 180, var27, 16776960, 0);
					var27 += 15;
					...
					var0.method4840(
							var18 + var9 + (Client.gameCycle % 40 < 20 ? class60.getColTags(16776960) + "|" : ""),
							class90.loginWindowX + 180 - 108, var27, 16777215, 0);
					var27 -= 8;
					...
					var0.method4840(
							FontTypeFace.appendTags(var17)
									+ (Client.gameCycle % 40 < 20 ? class60.getColTags(16776960) + "|" : ""),
							class90.loginWindowX + 180 - 34, var27, 16777215, 0);
					var27 += 15;
			...
			if (class90.field1413 > 0) {
				...
				for (var16 = 0; var16 < var8; ++var16) {
					var10 = ClanMember.field917[var7 + var29] - var27
							* ScriptState.field792[var29 + class90.field1421 & ScriptState.field792.length - 1] / 6;
					if (var10 < 0) {
						var10 = 0;
					}
				...
				for (var16 = var28 - var27; var16 < var28; ++var16) {
					class90.field1418[var16] = (int) (Math.sin((double) class90.field1422 / 14.0D) * 16.0D
							+ Math.sin((double) class90.field1422 / 15.0D) * 14.0D
							+ Math.sin((double) class90.field1422 / 16.0D) * 12.0D);
					++class90.field1422;
				}
			...
			if (class90.field1423 > 0) {
				for (var5 = 0; var5 < 256; ++var5) {
					if (class90.field1423 > 768) {
						class41.field577[var5] = Preferences.method1647(WidgetNode.field837[var5], class5.field41[var5],
								1024 - class90.field1423);
					} else if (class90.field1423 > 256) {
						class41.field577[var5] = class5.field41[var5];
					} else {
						class41.field577[var5] = Preferences.method1647(class5.field41[var5], WidgetNode.field837[var5],
								256 - class90.field1423);
					}
				}
			} else if (class90.field1420 > 0) {
				for (var5 = 0; var5 < 256; ++var5) {
					if (class90.field1420 > 768) {
						class41.field577[var5] = Preferences.method1647(WidgetNode.field837[var5], class1.field10[var5],
								1024 - class90.field1420);
					} else if (class90.field1420 > 256) {
						class41.field577[var5] = class1.field10[var5];
					} else {
						class41.field577[var5] = Preferences.method1647(class1.field10[var5], WidgetNode.field837[var5],
								256 - class90.field1420);
					}
				}
			} else {
				for (var5 = 0; var5 < 256; ++var5) {
			...
			for (var7 = 1; var7 < var26 - 1; ++var7) {
				...
				for (var10 = var16; var10 < 128; ++var10) {
					...
					if (var11 != 0) {
						...
						class12.field275.pixels[var29++] = (var13 * (var22 & '\uff00') + var21 * (var11 & '\uff00')
								& 16711680)
								+ ((var11 & 16711935) * var21 + (var22 & 16711935) * var13 & -16711936) >> 8;
					} else {
						++var29;
					}
				}
			...
			if (Client.gameState > 5 && Client.languageId == 0) {
				if (class64.field816 != null) {
					...
					var0.method4843("World" + " " + Client.world, var31 / 2 + var27, var30 / 2 + var28 - 2, 16777215,
							0);
	...
	static final void method1584(WidgetNode var0, boolean var1) {
		...
		for (IntegerNode var4 = (IntegerNode) Client.widgetFlags
				.method3646(); var4 != null; var4 = (IntegerNode) Client.widgetFlags.method3647()) {
	...
	static final void method1581() {
		...
		if (Occluder.field2140 - var0 < -500 || Occluder.field2140 - var0 > 500 || class40.field569 - var1 < -500
				|| class40.field569 - var1 > 500) {
		...
		if (MouseInput.field738 == 4 && class110.field1650) {
			...
			Client.field1000 = var2 != -1 && var2 != 1 ? (Client.field1000 + MouseInput.field746) / 2
					: MouseInput.field746;
			var3 = Client.field1153 - MouseInput.field745;
			Client.field1149 = var3 * 2;
			Client.field1153 = var3 != -1 && var3 != 1 ? (Client.field1153 + MouseInput.field745) / 2
					: MouseInput.field745;
		} else {
