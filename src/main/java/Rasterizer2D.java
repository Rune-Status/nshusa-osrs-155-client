public class Rasterizer2D extends CacheableNode {
	...
	public static void method5128(int var0, int var1, int var2, int var3) {
	...
	public static void method5129(int var0, int var1, int var2, int var3, int var4) {
	...
	public static void method5063(int var0, int var1, int var2, int var3) {
	...
	public static void method5054(int var0, int var1, int var2, int var3, int var4) {
		if (var4 != 0) {
			if (var4 == 256) {
				method5100(var0, var1, var2, var3);
			} else {
				if (var2 < 0) {
					var2 = -var2;
				}
	...
	public static void drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method5063(var0, var1, var2, var4);
		method5063(var0, var3 + var1 - 1, var2, var4);
		method5128(var0, var1, var3, var4);
		method5128(var0 + var2 - 1, var1, var3, var4);
	}

	public static void method5093(int var0, int var1, int var2, int var3, int var4, int var5, byte[] var6, int var7) {
		if (var0 + var2 >= 0 && var3 + var1 >= 0) {
			if (var0 < graphicsPixelsWidth && var1 < graphicsPixelsHeight) {
				...
				if (var12 == 255 && var13 == 255) {
					var14 = (var9 + var1) * graphicsPixelsWidth + var0 + var8;
	...
	static void method5100(int var0, int var1, int var2, int var3) {
		if (var2 == 0) {
			method5045(var0, var1, var3);
		} else {
			if (var2 < 0) {
				var2 = -var2;
			}
	...
	public static void drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) {
			if (var2 >= 0) {
				method5063(var0, var1, var2 + 1, var4);
			} else {
				method5063(var0 + var2, var1, -var2 + 1, var4);
			}

		} else if (var2 == 0) {
			if (var3 >= 0) {
				method5128(var0, var1, var3 + 1, var4);
			} else {
				method5128(var0, var3 + var1, -var3 + 1, var4);
			}
	...
	static void method5045(int var0, int var1, int var2) {
	...
	public static void method5059(int var0, int var1, int var2, int var3, int var4, int var5) {
		int var6 = 0;
		int var7 = 65536 / var3;
		if (var0 < draw_region_x) {
			var2 -= draw_region_x - var0;
	...
	public static void method5068(int var0, int var1, int var2, int[] var3, int[] var4) {
	...
	public static void method5062(int var0, int var1, int var2, int var3, int var4, int var5) {
		method5064(var0, var1, var2, var4, var5);
		method5064(var0, var3 + var1 - 1, var2, var4, var5);
		if (var3 >= 3) {
			method5106(var0, var1 + 1, var3 - 2, var4, var5);
			method5106(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5);
		}

	}

	static void method5064(int var0, int var1, int var2, int var3, int var4) {
		if (var1 >= drawingAreaTop && var1 < drawingAreaRight) {
			if (var0 < draw_region_x) {
				var2 -= draw_region_x - var0;
				var0 = draw_region_x;
	...
	public static void method5055(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		int var8 = 0;
		...
		for (int var15 = -var3; var15 < 0; ++var15) {
			...
			for (var16 = -var2; var16 < 0; ++var16) {
				...
				if (var11 == 0) {
					...
					graphicsPixels[var14++] = ((var21 & 16711935) * var10 >> 8 & 16711935)
							+ (var10 * (var21 & '\uff00') >> 8 & '\uff00')
							+ ((var17 & 16711935) * var11 >> 8 & 16711935)
							+ (var11 * (var17 & '\uff00') >> 8 & '\uff00');
				}
			}
			...
			if (var9 > 0) {
				...
				if (var5 != var4) {
					var12 = (var17 * (var5 & 16711935) + var16 * (var4 & 16711935) & -16711936)
							+ (var16 * (var4 & '\uff00') + var17 * (var5 & '\uff00') & 16711680) >>> 8;
				}
			}
	...
	public static void method5056(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		int var8 = 0;
		int var9 = var5 == var4 && var7 == var6 ? -1 : 65536 / var3;
		int var10 = var6;
		int var11 = 256 - var6;
		...
		for (int var20 = 0; var20 < var3; ++var20) {
			...
			for (var21 = -var2; var21 < 0; ++var21) {
				...
				if (var11 == 0) {
					...
					var15 = var23 < 127 ? var23 * var11 + (var12 * var23 * var10 >> 7) >> 8
							: var10 * (255 - ((255 - var12) * (255 - var23) >> 7)) + var23 * var11 >> 8;
					var16 = var24 < 127 ? (var13 * var24 * var10 >> 7) + var24 * var11 >> 8
							: var10 * (255 - ((255 - var13) * (255 - var24) >> 7)) + var24 * var11 >> 8;
					var17 = var25 < 127 ? var25 * var11 + (var14 * var25 * var10 >> 7) >> 8
							: var10 * (255 - ((255 - var14) * (255 - var25) >> 7)) + var25 * var11 >> 8;
				}
			...
			if (var9 > 0) {
				...
				if (var5 != var4) {
					var23 = (var21 * (var4 & 16711935) + var22 * (var5 & 16711935) & -16711936)
							+ (var21 * (var4 & '\uff00') + var22 * (var5 & '\uff00') & 16711680) >>> 8;
					var12 = var23 >> 16;
					var13 = (var23 & '\uff00') >> 8;
					var14 = var23 & 255;
				}
	...
	public static void method5057(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		int var8 = 0;
		int var9 = 65536 / var3;
		int var10 = var6;
		int var11 = 256 - var6;
	...
	public static void method5058(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		int var8 = 0;
		int var9 = 65536 / var3;
		int var10 = var6;
		int var11 = 256 - var6;
	...
	static void method5106(int var0, int var1, int var2, int var3, int var4) {
		if (var0 >= draw_region_x && var0 < drawingAreaBottom) {
			if (var1 < drawingAreaTop) {
				var2 -= drawingAreaTop - var1;
				var1 = drawingAreaTop;
