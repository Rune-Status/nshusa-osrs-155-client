public class PlayerComposition {
				...
				if (var15 == null) {
					...
					for (var13 = 0; var13 < 5; ++var13) {
						if (this.bodyPartColours[var13] < class208.colorsToReplace[var13].length) {
							var18.recolor(class152.colorsToFind[var13],
									class208.colorsToReplace[var13][this.bodyPartColours[var13]]);
						}

						if (this.bodyPartColours[var13] < SoundTask.field1648[var13].length) {
							var18.recolor(TextureProvider.field1767[var13],
									SoundTask.field1648[var13][this.bodyPartColours[var13]]);
						}
					}
			...
			if (var1) {
				...
				for (var5 = 0; var5 < 5; ++var5) {
					if (this.bodyPartColours[var5] < class208.colorsToReplace[var5].length) {
						var8.recolor(class152.colorsToFind[var5],
								class208.colorsToReplace[var5][this.bodyPartColours[var5]]);
					}

					if (this.bodyPartColours[var5] < SoundTask.field1648[var5].length) {
						var8.recolor(TextureProvider.field1767[var5],
								SoundTask.field1648[var5][this.bodyPartColours[var5]]);
					}
				}
	...
	public int method4070() {
		return this.transformedNpcId == -1
				...
				: 305419896 + class72.getNpcDefinition(this.transformedNpcId).id;
	}
