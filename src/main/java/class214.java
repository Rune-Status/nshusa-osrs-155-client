public class class214 {
	...
	public static final short[] field2641;

	public static final short[][] field2640;

	public static final short[] field2639;

	public static final short[][] field2642;

	static {
		field2641 = new short[] { (short) 6798, (short) 8741, (short) 25238, (short) 4626, (short) 4550 };
		field2640 = new short[][] {
		...
		field2639 = new short[] { (short) -10304, (short) 9104, (short) -1, (short) -1, (short) -1 };
		field2642 = new short[][] {
	...
	public static int method4103(CharSequence var0, CharSequence var1, int var2) {
		...
		while (var5 - var7 < var3 || var6 - var8 < var4) {
			...
			var7 = IndexFile.method3103(var9);
			var8 = IndexFile.method3103(var10);
			var9 = class60.method1067(var9, var2);
			var10 = class60.method1067(var10, var2);
			if (var10 != var9 && Character.toUpperCase(var9) != Character.toUpperCase(var10)) {
				var9 = Character.toLowerCase(var9);
				var10 = Character.toLowerCase(var10);
				if (var9 != var10) {
					return class85.method1768(var9, var2) - class85.method1768(var10, var2);
				}
			}
		}
		...
		for (var17 = 0; var17 < var16; ++var17) {
			...
			if (var11 != var12 && Character.toUpperCase(var11) != Character.toUpperCase(var12)) {
				...
				if (var11 != var12) {
					return class85.method1768(var11, var2) - class85.method1768(var12, var2);
				}
			}
		}
		...
		if (var17 != 0) {
			...
			for (int var18 = 0; var18 < var16; ++var18) {
				...
				if (var12 != var13) {
					return class85.method1768(var12, var2) - class85.method1768(var13, var2);
				}
			}
