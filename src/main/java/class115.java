public class class115 extends class117 {
	...
	int method2226(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field1687 > 0) {
				...
				if (this.field1676 == -256 && (this.field1681 & 255) == 0) {
					if (class33.highMemory) {
						var2 = method2328(0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
								this.field1690, this.field1682, this.field1677, this.field1686, 0, var6, var3, this);
					} else {
						var2 = method2237(((class105) super.field1705).field1596, var1, this.field1681, var2,
								this.field1680, this.field1689, 0, var6, var3, this);
					}
				} else if (class33.highMemory) {
					var2 = method2242(0, 0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
							this.field1690, this.field1682, this.field1677, this.field1686, 0, var6, var3, this,
							this.field1676, var5);
				} else {
					var2 = method2267(0, 0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
							this.field1680, this.field1689, 0, var6, var3, this, this.field1676, var5);
				}
			...
			if (this.field1676 == -256 && (this.field1681 & 255) == 0) {
				if (class33.highMemory) {
					return method2231(0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
							this.field1690, this.field1682, 0, var4, var3, this);
				}

				return method2271(((class105) super.field1705).field1596, var1, this.field1681, var2, this.field1680, 0,
						var4, var3, this);
			}

			if (class33.highMemory) {
				return method2235(0, 0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
						this.field1690, this.field1682, 0, var4, var3, this, this.field1676, var5);
			}

			return method2234(0, 0, ((class105) super.field1705).field1596, var1, this.field1681, var2, this.field1680,
					0, var4, var3, this, this.field1676, var5);
		}
	}
	...
	int method2225(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field1687 > 0) {
				...
				if (this.field1676 == 256 && (this.field1681 & 255) == 0) {
					if (class33.highMemory) {
						var2 = method2238(0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
								this.field1690, this.field1682, this.field1677, this.field1686, 0, var6, var3, this);
					} else {
						var2 = method2236(((class105) super.field1705).field1596, var1, this.field1681, var2,
								this.field1680, this.field1689, 0, var6, var3, this);
					}
				} else if (class33.highMemory) {
					var2 = method2240(0, 0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
							this.field1690, this.field1682, this.field1677, this.field1686, 0, var6, var3, this,
							this.field1676, var5);
				} else {
					var2 = method2239(0, 0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
							this.field1680, this.field1689, 0, var6, var3, this, this.field1676, var5);
				}
			...
			if (this.field1676 == 256 && (this.field1681 & 255) == 0) {
				if (class33.highMemory) {
					return method2229(0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
							this.field1690, this.field1682, 0, var4, var3, this);
				}

				return method2215(((class105) super.field1705).field1596, var1, this.field1681, var2, this.field1680, 0,
						var4, var3, this);
			}

			if (class33.highMemory) {
				return method2233(0, 0, ((class105) super.field1705).field1596, var1, this.field1681, var2,
						this.field1690, this.field1682, 0, var4, var3, this, this.field1676, var5);
			}

			return method2232(0, 0, ((class105) super.field1705).field1596, var1, this.field1681, var2, this.field1680,
					0, var4, var3, this, this.field1676, var5);
		}
	}
	...
	static int method2232(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, class115 var10, int var11, int var12) {
	...
	static int method2234(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, class115 var10, int var11, int var12) {
	...
	static int method2215(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
			class115 var8) {
		var2 >>= 8;
		var7 >>= 8;
		var4 <<= 2;
	...
	static int method2233(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, class115 var11, int var12, int var13) {
	...
	static int method2271(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
			class115 var8) {
		var2 >>= 8;
		var7 >>= 8;
		var4 <<= 2;
	...
	static int method2235(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, class115 var11, int var12, int var13) {
	...
	static int method2229(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, class115 var10) {
		var3 >>= 8;
		var9 >>= 8;
		var5 <<= 2;
		var6 <<= 2;
	...
	static int method2231(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, class115 var10) {
		var3 >>= 8;
		var9 >>= 8;
		var5 <<= 2;
	...
	static int method2239(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, class115 var11, int var12, int var13) {
	...
	static int method2267(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, class115 var11, int var12, int var13) {
		var11.field1690 -= var11.field1677 * var5;
		var11.field1682 -= var11.field1686 * var5;
		if (var12 == 0 || (var8 = var5 + (var10 + 256 - var4 + var12) / var12) > var9) {
	...
	static int method2236(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			class115 var9) {
		var2 >>= 8;
		var8 >>= 8;
		var4 <<= 2;
	...
	static int method2237(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			class115 var9) {
		var2 >>= 8;
		var8 >>= 8;
		var4 <<= 2;
	...
	static int method2240(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, int var11, int var12, class115 var13, int var14, int var15) {
	...
	static int method2242(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, int var11, int var12, class115 var13, int var14, int var15) {
		var13.field1680 -= var5 * var13.field1689;
	...
	static int method2238(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, int var11, class115 var12) {
		var3 >>= 8;
		var11 >>= 8;
		var5 <<= 2;
		var6 <<= 2;
	...
	static int method2328(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, int var11, class115 var12) {
		var3 >>= 8;
		var11 >>= 8;
		var5 <<= 2;
	...
	public static class115 method2201(class105 var0, int var1, int var2) {
		return var0.field1596 != null && var0.field1596.length != 0 ? new class115(var0,
				(int) ((long) var0.field1597 * 256L * (long) var1 / (long) (class31.sampleRate * 100)), var2 << 6)
				: null;
	}
}
