				...
				if (var2 == 14) {
					...
					if (var2 == 24) {
						...
						if (var2 == 25) {
							...
							if (var16 != null) {
								class89.method1783();
								Ignore.method1146(var1, var0, class1.method2(class244.getWidgetConfig(var16)),
										var16.itemId);
								...
								if (var16.hasScript) {
									...
									Client.field948 = class60.getColTags('\uff00') + var16.field2774
											+ class60.getColTags(16777215);
								}
							}
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								if (var2 == 38) {
									...
									Client.field1067 = class60.getColTags(16748608)
											+ class46.getItemDefinition(var3).name + class60.getColTags(16777215);
									...
									label1076: {
										if (var2 != 57) {
											...
											if (var2 == 1001) {
												...
												Client.secretPacketBuffer1
														.putByte(KeyFocusListener.field655[82] ? 1 : 0);
												Client.secretPacketBuffer1.method3365(var3 >> 14 & 32767);
												Client.secretPacketBuffer1.method3365(var0 + WallObject.baseX);
												break label1076;
											}
											...
											if (var2 == 1002) {
												...
												Client.field1171 = 0;
												Client.secretPacketBuffer1
														.putOpcode(Opcodes.PACKET_CLIENT_EXAMINE_OBSTACLE);
												if (Client.RUNELITE_PACKET) {
													Client.secretPacketBuffer1.runeliteWriteInt(var3 >> 14 & 32767);
												} else {
													Client.secretPacketBuffer1.putShort(var3 >> 14 & 32767);
											...
											if (var2 == 1003) {
												...
												if (var8 != null) {
													...
													if (var12 != null) {
														Client.secretPacketBuffer1
																.putOpcode(Opcodes.PACKET_CLIENT_EXAMINE_NPC);
														if (Client.RUNELITE_PACKET) {
											...
											if (var2 == 1004) {
												...
												Client.field1171 = 0;
												Client.secretPacketBuffer1
														.putOpcode(Opcodes.PACKET_CLIENT_EXAMINE_ITEM);
												if (Client.RUNELITE_PACKET) {
													Client.secretPacketBuffer1.runeliteWriteInt(var3);
												} else {
													Client.secretPacketBuffer1.method3365(var3);
											...
											if (var2 == 1005) {
												...
												if (var16 != null && var16.itemQuantities[var0] >= 100000) {
													MessageNode.sendGameMessage(27, "", var16.itemQuantities[var0]
															+ " x " + class46.getItemDefinition(var3).name);
												} else {
													Client.secretPacketBuffer1
															.putOpcode(Opcodes.PACKET_CLIENT_EXAMINE_ITEM);
													if (Client.RUNELITE_PACKET) {
											...
											if (var2 != 1007) {
												if (var2 == 1009 || var2 == 1008 || var2 == 1010 || var2 == 1011
														|| var2 == 1012) {
													GameObject.renderOverview.method5323(var2, var3,
															new Coordinates(var0), new Coordinates(var1));
												}
												break label1076;
											}
										}
										...
										if (var16 != null) {
											...
											if (var10 != null) {
												...
												if (var13 && class110.method2171(class244.getWidgetConfig(var10),
														var3 - 1)) {
													if (var3 == 1) {
