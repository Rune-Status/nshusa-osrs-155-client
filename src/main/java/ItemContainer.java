		...
		if (AbstractByteBuffer.localPlayer != var0) {
			if (Client.menuOptionCount < 400) {
				...
				if (var0.totalLevel == 0) {
					...
					var4 = var0.actions[0] + var0.name + var0.actions[1] + " " + " (" + "skill-" + var0.totalLevel + ")"
							+ var0.actions[2];
				}
				...
				if (Client.itemSelectionState == 1) {
					class10.addMenuEntry("Use",
							Client.field1067 + " " + "->" + " " + class60.getColTags(16777215) + var4, 14, var1, var2,
							var3);
				} else if (Client.spellSelected) {
					if ((WorldMapType1.field451 & 8) == 8) {
						class10.addMenuEntry(Client.field1071,
								Client.field948 + " " + "->" + " " + class60.getColTags(16777215) + var4, 15, var1,
								var2, var3);
					}
				} else {
					for (var10 = 7; var10 >= 0; --var10) {
						if (Client.playerOptions[var10] != null) {
							...
							if (Client.playerOptions[var10].equalsIgnoreCase("Attack")) {
								...
								if (Client.field946 == class89.field1401 || class89.field1404 == Client.field946
										&& var0.combatLevel > AbstractByteBuffer.localPlayer.combatLevel) {
									var11 = 2000;
								}
							...
							class10.addMenuEntry(Client.playerOptions[var10], class60.getColTags(16777215) + var4, var7,
									var1, var2, var3);
						}
					}
				}
