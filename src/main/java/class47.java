	...
	public static Font method720(IndexDataBase var0, IndexDataBase var1, String var2, String var3) {
		...
		if (!class249.method4517(var0, var4, var5)) {
			...
			if (var8 == null) {
				...
				Font var9 = new Font(var8, class287.field3807, World.offsetsY, class236.field3238, FileSystem.field3207,
						class181.field2456, class208.spritePixels);
				Actor.method1605();
				var7 = var9;
			}
	...
	static final void groundItemSpawned(int var0, int var1) {
		...
		if (var2 == null) {
			...
			if (var5 == null) {
				...
				class8.region.addItemPile(class5.plane, var0, var1,
						CacheFile.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, class5.plane), var5, var9, var11,
						var10);
			}
		}
	}
