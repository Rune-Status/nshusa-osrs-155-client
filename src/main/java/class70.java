...
public class class70 implements Runnable {
	...
	class70() {
		this.field859 = true;
		this.field860 = new Object();
		this.field861 = 0;
		this.field862 = new int[500];
		this.field863 = new int[500];
	}

	public void run() {
		for (; this.field859; class211.method4044(50L)) {
			Object var1 = this.field860;
			synchronized (this.field860) {
				if (this.field861 < 500) {
					this.field862[this.field861] = MouseInput.field745;
					this.field863[this.field861] = MouseInput.field746;
					++this.field861;
				}
			}
		}
	...
	public static void encodeClassVerifier(PacketBuffer var0) {
		ClassInfo var1 = (ClassInfo) class281.field3766.method3664();
		if (var1 != null) {
			int var2 = var0.offset;
			var0.putInt(var1.field3756);
				...
				if (var1.errorIdentifiers[var3] != 0) {
					...
					try {
						...
						if (var4 == 0) {
							...
							var5 = var1.fields[var3];
							var5.setInt((Object) null, var1.field3761[var3]);
							var0.putByte(0);
						} else if (var4 == 2) {
							var5 = var1.fields[var3];
	...
	public static IndexedSprite getSprite(IndexDataBase var0, String var1, String var2) {
		...
		return class261.method4814(var0, var3, var4);
	}
}
