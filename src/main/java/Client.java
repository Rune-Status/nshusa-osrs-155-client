...
public final class Client extends GameEngine {
	...
	void method1297() {
		...
		if (class23.preferences != null) {
			try {
				class52.method796(PendingSpawn.clientInstance, "resize",
						new Object[] { Integer.valueOf(class19.method142()) });
			...
			try {
							...
							if (var25 != 0 && var25 != 1 && var25 != 2) {
								if (var25 == 3 || var25 == 4) {
									...
									for (int var17 = 0; var17 < var16.length; ++var17) {
										...
										if (var18.getName().equals(var111)) {
								...
								var92.fields[var26] = class41.method594(var83).getDeclaredField(var111);
							}
				...
				if (packetType == Opcodes.PACKET_SERVER_222) {
					if (RUNELITE_PACKET) {
						...
						var2 = secretPacketBuffer2.readUShortA();
					}
				...
				if (packetType == Opcodes.PACKET_SERVER_128) {
					...
					try {
						...
						if (var24.length() == 0) {
							...
							var83 = class182.field2458[var35 - 1] + ", " + var11 / 10 + var11 % 10 + "-"
									+ class182.field2460[0][var117] + "-" + var13 + " " + var14 / 10 + var14 % 10 + ":"
									+ var53 / 10 + var53 % 10 + ":" + var54 / 10 + var54 % 10 + " GMT";
				...
				if (packetType == Opcodes.PACKET_SERVER_146) {
					...
					var22 = FontTypeFace
							.appendTags(DecorativeObject.method2967(class229.method4204(secretPacketBuffer2)));
				...
				if (packetType == Opcodes.PACKET_SERVER_126) {
					...
					for (PendingSpawn var98 = (PendingSpawn) pendingSpawns
							.getFront(); var98 != null; var98 = (PendingSpawn) pendingSpawns.getNext()) {
						if (var98.x >= class31.field453 && var98.x < class31.field453 + 8 && var98.y >= Actor.field1270
								&& var98.y < Actor.field1270 + 8 && var98.level == class5.plane) {
							var98.hitpoints = 0;
						}
					}
				...
				if (packetType == Opcodes.PACKET_SERVER_188) {
					...
					if (var23 != var71.originalX || var2 != var71.originalY || var71.field2645 != 0
							|| var71.field2664 != 0) {
				...
				if (packetType != 57 && packetType != 40 && packetType != 163 && packetType != 143 && packetType != 44
						&& packetType != 195 && packetType != 187 && packetType != 23 && packetType != 19) {
					...
					if (packetType == Opcodes.PACKET_SERVER_54) {
						...
						if (var99) {
							...
							for (var25 = 0; var25 < class21.clanChatCount
									&& (!WorldMapType1.clanMembers[var25].username.equals(var24)
											|| var3 != WorldMapType1.clanMembers[var25].world); ++var25) {
								;
							}
					...
					if (packetType == Opcodes.PACKET_SERVER_37) {
						...
						Permission var78 = (Permission) class48.forOrdinal(ClanMember.method1195(),
					...
					if (packetType == Opcodes.PACKET_SERVER_11) {
						...
						if (class66.field830 >= 100) {
							...
							ScriptState.cameraZ = CacheFile.getTileHeight(class211.cameraX, ChatLineBuffer.cameraY,
									class5.plane) - class15.field303;
						}
					...
					if (packetType == Opcodes.PACKET_SERVER_168) {
						...
						Permission var9 = (Permission) class48.forOrdinal(ClanMember.method1195(),
								secretPacketBuffer2.readUnsignedByte());
					...
					if (packetType == Opcodes.PACKET_SERVER_65) {
						...
						for (; secretPacketBuffer2.offset < packetLength; WorldMapData.setItemTableSlot(var3, var26,
								var25 - 1, var34)) {
					...
					if (packetType == Opcodes.PACKET_SERVER_17) {
						...
						for (var5 = (WidgetNode) componentTable
								.method3646(); var5 != null; var5 = (WidgetNode) componentTable.method3647()) {
							if (var5.field836) {
								var5.field836 = false;
							} else {
								...
								if (!var66) {
									if (var22.equals(var31.name)) {
										if (var26 != var31.world) {
											...
											for (class66 var32 = (class66) field998
													.method3745(); var32 != null; var32 = (class66) field998
															.method3751()) {
				...
				var24 = "" + packetType + "," + secondLastFrameId + "," + thridLastFrameId + "," + packetLength + ","
						+ (AbstractByteBuffer.localPlayer.pathX[0] + WallObject.baseX) + ","
						+ (AbstractByteBuffer.localPlayer.pathY[0] + Varcs.baseY) + ",";
					...
					if (KeyFocusListener.field654 >= 0) {
						while (KeyFocusListener.field657 != KeyFocusListener.field654) {
							...
							if (var44 < 0) {
								...
								if (!KeyFocusListener.field655[var44]
										&& KeyFocusListener.field662 < KeyFocusListener.field658.length - 1) {
					...
					if (gameState == 20) {
						...
						for (var44 = 0; var44 < class37.field529.length; ++var44) {
							if (BuildType.field3191[var44] != -1 && class37.field529[var44] == null) {
								class37.field529[var44] = class226.indexMaps.getConfigData(BuildType.field3191[var44],
										0);
							...
							if (landRegionFielIds[var44] != -1 && class12.field277[var44] == null) {
								class12.field277[var44] = class226.indexMaps.getConfigData(landRegionFielIds[var44], 0,
										class37.xteaKeys[var44]);
						...
						if (!var57) {
							...
							if (!var57) {
								...
								if (field1031 != 0) {
									class14.drawStatusBox("Loading - please wait." + "<br>" + " (" + 100 + "%" + ")",
											true);
								}
								...
								for (class80 var56 = (class80) class80.field1324
										.getFront(); var56 != null; var56 = (class80) class80.field1324.getNext()) {
								...
								if (!isDynamicRegion) {
									...
									for (var45 = 0; var45 < var44; ++var45) {
										...
										if (var6 != null) {
											class28.method234();
											class56.method849(var6, var4, var5, class43.field589 * 8 - 48,
													Signlink.field2245 * 8 - 48, collisionMaps);
										}
									}
									...
									label497: while (true) {
										...
										if (var45 >= 4) {
											...
											while (true) {
												...
												for (var4 = 0; var4 < 13; ++var4) {
													label454: for (var5 = 0; var5 < 13; ++var5) {
																	...
																	while (true) {
																		...
																		while (true) {
																			...
																			if (var7 == var27 && var26 >= var16
																					...
																					&& var25 >= var17
																					&& var25 < var17 + 8) {
																				ObjectComposition var31 = Occluder
																						.getObjectDefinition(var21);
																				int var34 = var26 & 7;
																				int var35 = var25 & 7;
																				...
																				var39 = var14 + var33;
																				int var40 = var15 + class207.method3999(
																						var26 & 7, var25 & 7, var8,
																						var31.sizeX, var31.sizeY,
																						var30);
																				if (var39 > 0 && var40 > 0
																						&& var39 < 103 && var40 < 103) {
																					int var41 = var45;
																					if ((class61.tileSettings[1][var39][var40]
																							& 2) == 2) {
																						var41 = var45 - 1;
																					}
																					...
																					World.addObject(var45, var39, var40,
																							var21, var8 + var30 & 3,
																							var29, var18, var42);
																				}
																			}
											...
											for (var5 = 0; var5 < 13; ++var5) {
												...
												if (var7 != -1) {
													...
													for (int var13 = 0; var13 < CombatInfo1.mapRegions.length; ++var13) {
														if (CombatInfo1.mapRegions[var13] == var12
																&& class37.field529[var13] != null) {
															ISAACCipher.method3540(class37.field529[var13], var45,
																	var4 * 8, var5 * 8, var8, (var10 & 7) * 8,
																	(var11 & 7) * 8, var9, collisionMaps);
															var58 = true;
															break;
														}
													}
	...
	final void method1365() {
		...
		if (!isMenuOpen) {
			...
			for (var8 = 0; var8 < menuOptionCount; ++var8) {
				var9 = 31 + var2 + (menuOptionCount - 1 - var8) * 15;
				var10 = 16777215;
			...
			for (int var12 = 0; var12 < field1116; ++var12) {
				if (widgetBoundsWidth[var12] + widgetPositionX[var12] > var8 && widgetPositionX[var12] < var10 + var8
						&& widgetBoundsHeight[var12] + widgetPositionY[var12] > var9
						&& widgetPositionY[var12] < var11 + var9) {
		...
		if (gameDrawingMode == 3) {
			for (var1 = 0; var1 < field1116; ++var1) {
				if (field1034[var1]) {
					Rasterizer2D.fillRectangle(widgetPositionX[var1], widgetPositionY[var1], widgetBoundsWidth[var1],
							widgetBoundsHeight[var1], 16711935, 128);
				} else if (field1119[var1]) {
					Rasterizer2D.fillRectangle(widgetPositionX[var1], widgetPositionY[var1], widgetBoundsWidth[var1],
							widgetBoundsHeight[var1], 16711680, 128);
				}
			}
		}
		...
		for (class80 var13 = (class80) class80.field1324.getFront(); var13 != null; var13 = (class80) class80.field1324
				.getNext()) {
					...
					if (var13.field1315 == null) {
						if (var13.field1322 != null && (var13.field1323 -= var4) <= 0) {
							...
							if (var18 != null) {
								...
								var13.field1323 = var13.field1320
										+ (int) (Math.random() * (double) (var13.field1321 - var13.field1320));
							}
						}
					} else {
	...
	protected final void vmethod1205(boolean var1) {
		...
		if ((gameState == 10 || gameState == 20 || gameState == 30) && field1126 != 0L
				&& class147.currentTimeMs() > field1126) {
		...
		if (gameState == 30 && gameDrawingMode == 0 && !var1 && !isResized) {
			for (var3 = 0; var3 < field1116; ++var3) {
				if (field1119[var3]) {
					class12.field275.vmethod5133(widgetPositionX[var3], widgetPositionY[var3], widgetBoundsWidth[var3],
							widgetBoundsHeight[var3]);
	...
	final void method1209() {
		try {
			...
			int var7;
			if (loginState == 5) {
				int[] var9 = new int[] { (int) (Math.random() * 9.9999999E7D), (int) (Math.random() * 9.9999999E7D),
						(int) (MessageNode.field875 >> 32), (int) (MessageNode.field875 & -1L) };
				secretPacketBuffer1.offset = 0;
				...
				secretPacketBuffer1.encryptRsa(class88.RSA_EXPONENT, class88.RSA_MODULUS);
				field965.offset = 0;
				if (gameState == 40) {
					field965.putByte(18);
				} else {
			...
			if (loginState == 8) {
				field1030 = 0;
				class1.method3("You have only just left another world.", "Your profile will be transferred in:",
						field1017 / 60 + " seconds.");
				if (--field1017 <= 0) {
					loginState = 0;
				}
				...
				if (loginState == 9 && class268.rssocket.available() >= 13) {
					...
					if (var18) {
						...
						if (class23.preferences.preferences.size() >= 10
								&& !class23.preferences.preferences.containsKey(Integer.valueOf(var6))) {
			...
			if (gameState == 30) {
				...
				synchronized (class110.field1653.field860) {
					if (!field1188) {
						...
						for (var4 = 0; var4 < class110.field1653.field861
								&& secretPacketBuffer1.offset - var2 < 240; ++var4) {
							++var3;
				...
				if (KeyFocusListener.field655[96] || KeyFocusListener.field655[97] || KeyFocusListener.field655[98]
						|| KeyFocusListener.field655[99]) {
					field1003 = true;
				}
					...
					if (field969 > 750) {
						...
						while (true) {
							...
							do {
										...
										do {
											...
											if (var34 == null) {
												while (true) {
													do {
														...
														if (var34 == null) {
															...
															if (GameObject.renderOverview != null) {
																GameObject.renderOverview.method5326(class5.plane,
																		(AbstractByteBuffer.localPlayer.x >> 7)
																				+ WallObject.baseX,
																		(AbstractByteBuffer.localPlayer.y >> 7)
																				+ Varcs.baseY,
																		false);
															...
															if (ClanMember.field915 != null) {
																...
																if (MouseInput.field738 == 0) {
																	if (field1105) {
																		if (Timer.field2270 == ClanMember.field915
																				&& field1113 != field1025) {
																			Widget var36 = ClanMember.field915;
																			byte var31 = 0;
																			if (field1076 == 1
																					&& var36.contentType == 206) {
																				var31 = 1;
																			}
																			...
																			if (class39.method538(
																					class244.getWidgetConfig(var36))) {
																				var6 = field1025;
																				var7 = field1113;
																			...
																			secretPacketBuffer1.putOpcode(
																					Opcodes.PACKET_CLIENT_185);
																			if (RUNELITE_PACKET) {
																				secretPacketBuffer1
																						.runeliteWriteInt(field1113);
																				secretPacketBuffer1.runeliteWriteInt(
																						ClanMember.field915.id);
																				secretPacketBuffer1
																						.runeliteWriteInt(field1025);
																				secretPacketBuffer1
																						.runeliteWriteInt(var31);
																			} else {
																				secretPacketBuffer1
																						.method3270(field1113);
																				secretPacketBuffer1.method3279(
																						ClanMember.field915.id);
																				secretPacketBuffer1
																						.putShortLE(field1025);
																	...
																	ClanMember.field915 = null;
																		...
																		&& (MouseInput.field745 > field1026 + 5
																				|| MouseInput.field745 < field1026 - 5
																				|| MouseInput.field746 > field1135 + 5
																				|| MouseInput.field746 < field1135
																						- 5)) {
																	field1105 = true;
																}
															}
															...
															if (Region.method2805()) {
																...
																secretPacketBuffer1
																		.method3261(KeyFocusListener.field655[82]
																				? (KeyFocusListener.field655[81] ? 2
																						: 1)
																				: 0);
															...
															if (field1160) {
																...
																var6 = CacheFile.getTileHeight(var4, var5, class5.plane)
																		- class15.field303;
																if (class211.cameraX < var4) {
																	class211.cameraX = (var4 - class211.cameraX)
																			* class66.field830 / 1000 + class211.cameraX
																			+ class221.field2820;
																	if (class211.cameraX > var4) {
																...
																if (class211.cameraX > var4) {
																	class211.cameraX -= class66.field830
																			* (class211.cameraX - var4) / 1000
																			+ class221.field2820;
																	if (class211.cameraX < var4) {
																		class211.cameraX = var4;
																	}
																...
																if (ScriptState.cameraZ < var6) {
																	ScriptState.cameraZ = (var6 - ScriptState.cameraZ)
																			* class66.field830 / 1000
																			+ ScriptState.cameraZ + class221.field2820;
																	if (ScriptState.cameraZ > var6) {
																...
																if (ScriptState.cameraZ > var6) {
																	ScriptState.cameraZ -= class66.field830
																			* (ScriptState.cameraZ - var6) / 1000
																			+ class221.field2820;
																	if (ScriptState.cameraZ < var6) {
																		ScriptState.cameraZ = var6;
																	}
																...
																if (ChatLineBuffer.cameraY < var5) {
																	ChatLineBuffer.cameraY += class221.field2820
																			+ (var5 - ChatLineBuffer.cameraY)
																					* class66.field830 / 1000;
																	if (ChatLineBuffer.cameraY > var5) {
																...
																if (ChatLineBuffer.cameraY > var5) {
																	ChatLineBuffer.cameraY -= class66.field830
																			* (ChatLineBuffer.cameraY - var5) / 1000
																			+ class221.field2820;
																	if (ChatLineBuffer.cameraY < var5) {
																		ChatLineBuffer.cameraY = var5;
																	}
																...
																int var10 = (int) Math
																		.sqrt((double) (var9 * var9 + var7 * var7));
																int var11 = (int) (Math.atan2((double) var8,
																		(double) var10) * 325.949D) & 2047;
																int var12 = (int) (Math.atan2((double) var7,
																		(double) var9) * -325.949D) & 2047;
																if (var11 < 128) {
																	var11 = 128;
																}
																...
																if (class9.cameraPitch < var11) {
																	class9.cameraPitch += (var11 - class9.cameraPitch)
																			* class28.field427 / 1000
																			+ class181.field2454;
																	if (class9.cameraPitch > var11) {
																...
																if (class9.cameraPitch > var11) {
																	class9.cameraPitch -= class28.field427
																			* (class9.cameraPitch - var11) / 1000
																			+ class181.field2454;
																	if (class9.cameraPitch < var11) {
																		class9.cameraPitch = var11;
																	}
																...
																if (var13 > 0) {
																	class174.cameraYaw = var13 * class28.field427 / 1000
																			+ class174.cameraYaw + class181.field2454;
																	class174.cameraYaw &= 2047;
																}

																if (var13 < 0) {
																	class174.cameraYaw -= -var13 * class28.field427
																			/ 1000 + class181.field2454;
																	class174.cameraYaw &= 2047;
																}
															...
															if (var4 > 15000 && var5 > 15000) {
																...
																secretPacketBuffer1
																		.putOpcode(Opcodes.PACKET_CLIENT_149);
															}

															for (class66 var37 = (class66) field998
																	.method3745(); var37 != null; var37 = (class66) field998
																			.method3751()) {
																if ((long) var37.field833 < class147.currentTimeMs()
																		/ 1000L - 5L) {
																	if (var37.field828 > 0) {
																		MessageNode.sendGameMessage(5, "",
																				var37.field829 + " has logged in.");
																	}

																	if (var37.field828 == 0) {
																		MessageNode.sendGameMessage(5, "",
																				var37.field829 + " has logged out.");
																	}
															...
															if (audioEffectCount > 50) {
																secretPacketBuffer1
																		.putOpcode(Opcodes.PACKET_CLIENT_KEEPALIVE);
															}

															try {
																if (class268.rssocket != null
																		&& secretPacketBuffer1.offset > 0) {
																	class268.rssocket.queueForWrite(
													...
													} while (var26 == null || var26.children == null
															|| var25.index >= var26.children.length
															|| var25 != var26.children[var25.index]);
								...
								var26 = PacketBuffer.method3528(var25.parentId);
							} while (var26 == null || var26.children == null || var25.index >= var26.children.length
									|| var25 != var26.children[var25.index]);
			...
			if (field1052 == null) {
				...
				if (isMenuOpen) {
					...
					if (var1 != 1 && (class110.field1650 || var1 != 4)) {
						...
						if (var2 < class54.menuX - 10 || var2 > class54.menuX + class20.menuWidth + 10
								|| var3 < class10.menuY - 10 || var3 > class10.menuY + class28.menuHeight + 10) {
							isMenuOpen = false;
					...
					if (var1 == 1 || !class110.field1650 && var1 == 4) {
						...
						if (var7 != -1 && var7 >= 0) {
							...
							class257.menuAction(var17, var9, var10, var11, var12, var13, MouseInput.field752,
									MouseInput.field753);
						}
					...
					label269: {
						...
						if ((var1 == 1 || !class110.field1650 && var1 == 4) && menuOptionCount > 0 && var2 >= 0) {
							...
							class257.menuAction(var4, var5, var6, var7, var15, var16, MouseInput.field752,
									MouseInput.field753);
						}
	...
	public final void init() {
		if (this.isValidHost()) {
			...
			for (int var2 = 0; var2 < var1.length; ++var2) {
				...
				if (var4 != null) {
					...
					default:
						break;
					case 4:
						class232[] var23 = new class232[] { class232.field3199, class232.field3194, class232.field3192,
								class232.field3196, class232.field3193, class232.field3197 };
			...
			try {
				...
				class17.cacheLocations = new String[] { "c:/rscache/", "/rscache/", "c:/windows/", "c:/winnt/", "c:/",
						class89.userHome, "/tmp/", "" };
				class72.field879 = new String[] { ".jagex_cache_" + Ignore.field858, ".file_store_" + Ignore.field858 };

				File var26;
				label153: for (int var10 = 0; var10 < 4; ++var10) {
				...
				try {
					...
					if (var22.exists()) {
						...
						label131: for (int var11 = 0; var11 < class72.field879.length; ++var11) {
							for (var6 = 0; var6 < class17.cacheLocations.length; ++var6) {
								var26 = new File(class17.cacheLocations[var6] + class72.field879[var11]
				...
				class155.field2261 = new CacheFile(
						new FileOnDisk(IndexFile.method3104("main_file_cache.dat2"), "rw", 1048576000L), 5200, 0);
				class155.field2260 = new CacheFile(
						new FileOnDisk(IndexFile.method3104("main_file_cache.idx255"), "rw", 1048576L), 6000, 0);
				class96.field1514 = new CacheFile[class267.field3668];

				for (int var12 = 0; var12 < class267.field3668; ++var12) {
					class96.field1514[var12] = new CacheFile(
							new FileOnDisk(IndexFile.method3104("main_file_cache.idx" + var12), "rw", 1048576L), 6000,
							0);
				}
