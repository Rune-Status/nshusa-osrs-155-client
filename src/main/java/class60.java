			...
			if ((var4 & 16) != 0) {
				...
				if (var3.name != null && var3.composition != null) {
					...
					if (!var22 && Client.field1175 == 0 && !var3.hidden) {
						...
						class94.field1488.offset = 0;
						String var19 = FontTypeFace
								.appendTags(DecorativeObject.method2967(class229.method4204(class94.field1488)));
						var3.overhead = var19.trim();
						var3.field1224 = var6 >> 8;
						var3.field1225 = var6 & 255;
						var3.field1223 = 150;
						var3.field1221 = var23;
						var3.inSequence = var3 != AbstractByteBuffer.localPlayer && var20.field3183
								&& "" != Client.field1131 && var19.toLowerCase().indexOf(Client.field1131) == -1;
						if (var20.field3182) {
							var13 = var23 ? 91 : 1;
						} else {
							var13 = var23 ? 90 : 2;
