			...
			if (var0 == 4101) {
				...
				if (var0 == 4102) {
					...
					if (var0 == 4104) {
						...
						class81.scriptStringStack[++class81.scriptStringStackSize - 1] = var26 + "-"
								+ class81.field1343[var29] + "-" + var22;
						return 1;
					} else if (var0 == 4105) {
						class81.scriptStringStackSize -= 2;
						var3 = class81.scriptStringStack[class81.scriptStringStackSize];
						var27 = class81.scriptStringStack[class81.scriptStringStackSize + 1];
						if (AbstractByteBuffer.localPlayer.composition != null
								&& AbstractByteBuffer.localPlayer.composition.isFemale) {
						...
						var26 = class214.method4103(class81.scriptStringStack[class81.scriptStringStackSize],
								class81.scriptStringStack[class81.scriptStringStackSize + 1], Client.languageId);
						byte var31;
						if (var26 > 0) {
							var31 = 1;
						} else if (var26 < 0) {
						...
						if (var0 == 4108) {
							...
							var3 = class81.scriptStringStack[--class81.scriptStringStackSize];
							class81.scriptStringStack[++class81.scriptStringStackSize - 1] = FontTypeFace
									.appendTags(var3);
							return 1;
						} else if (var0 == 4112) {
							var3 = class81.scriptStringStack[--class81.scriptStringStackSize];
