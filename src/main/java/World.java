public class World {
	...
	static final void addObject(int var0, int var1, int var2, int var3, int var4, int var5, Region var6,
			CollisionData var7) {
		if (!Client.lowMemory || (class61.tileSettings[0][var1][var2] & 2) != 0
				|| (class61.tileSettings[var0][var1][var2] & 16) == 0) {
			...
			if (var8.method4633()) {
				...
				if (var21.field1322 != null) {
					var21.field1323 = var21.field1320
							+ (int) (Math.random() * (double) (var21.field1321 - var21.field1320));
				}
			}
			...
			if (var5 == 22) {
				if (!Client.lowMemory || var8.field3439 != 0 || var8.interactType == 1 || var8.field3476) {
					if (var8.animationId == -1 && var8.impostorIds == null) {
						...
						var30 = new DynamicObject(var3, 22, var4, var0, var1, var2, var8.animationId, true,
								(Renderable) null);
					}
				...
				if (var5 >= 12) {
					if (var8.animationId == -1 && var8.impostorIds == null) {
						...
						var30 = new DynamicObject(var3, var5, var4, var0, var1, var2, var8.animationId, true,
								(Renderable) null);
					}
					...
					if (var8.animationId == -1 && var8.impostorIds == null) {
						...
						var30 = new DynamicObject(var3, 0, var4, var0, var1, var2, var8.animationId, true,
								(Renderable) null);
					}

					var6.addBoundary(var0, var1, var2, var16, (Renderable) var30, (Renderable) null,
							class61.field783[var4], 0, var19, var20);
					if (var4 == 0) {
						if (var8.clipped) {
					...
					if (var8.animationId == -1 && var8.impostorIds == null) {
						...
						var30 = new DynamicObject(var3, 1, var4, var0, var1, var2, var8.animationId, true,
								(Renderable) null);
					}

					var6.addBoundary(var0, var1, var2, var16, (Renderable) var30, (Renderable) null,
							class61.field771[var4], 0, var19, var20);
					if (var8.clipped) {
						if (var4 == 0) {
							class174.field2411[var0][var1][var2 + 1] = 50;
						} else if (var4 == 1) {
					...
					if (var5 == 2) {
						...
						if (var8.animationId == -1 && var8.impostorIds == null) {
							...
							var27 = new DynamicObject(var3, 2, var4 + 4, var0, var1, var2, var8.animationId, true,
									(Renderable) null);
							var28 = new DynamicObject(var3, 2, var26, var0, var1, var2, var8.animationId, true,
									(Renderable) null);
						}

						var6.addBoundary(var0, var1, var2, var16, (Renderable) var27, (Renderable) var28,
								class61.field783[var4], class61.field783[var26], var19, var20);
						if (var8.modelClipped) {
							if (var4 == 0) {
								class168.field2350[var0][var1][var2] |= 585;
								class168.field2350[var0][var1][var2 + 1] |= 1170;
						...
						if (var8.animationId == -1 && var8.impostorIds == null) {
							...
							var30 = new DynamicObject(var3, 3, var4, var0, var1, var2, var8.animationId, true,
									(Renderable) null);
						}
						...
						if (var8.animationId == -1 && var8.impostorIds == null) {
							...
							var30 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId, true,
									(Renderable) null);
						}

						var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable) var30, (Renderable) null,
								class61.field783[var4], 0, 0, 0, var19, var20);
					} else if (var5 == 5) {
						var26 = 16;
						...
						if (var8.animationId == -1 && var8.impostorIds == null) {
							...
							var28 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId, true,
									(Renderable) null);
						}

						var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable) var28, (Renderable) null,
								class61.field783[var4], 0, var26 * class61.field782[var4],
								var26 * class61.field770[var4], var19, var20);
					} else if (var5 == 6) {
						var26 = 8;
						var22 = var6.method2848(var0, var1, var2);
						if (var22 != 0) {
						...
						if (var8.animationId == -1 && var8.impostorIds == null) {
							...
							var28 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId, true,
									(Renderable) null);
						}

						var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable) var28, (Renderable) null, 256,
								var4, var26 * class61.field774[var4], var26 * class61.field775[var4], var19, var20);
					} else if (var5 == 7) {
						var22 = var4 + 2 & 3;
						if (var8.animationId == -1 && var8.impostorIds == null) {
							var30 = var8.getModel(4, var22 + 4, var15, var17, var16, var18);
						} else {
							var30 = new DynamicObject(var3, 4, var22 + 4, var0, var1, var2, var8.animationId, true,
									(Renderable) null);
						}

						var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable) var30, (Renderable) null, 256,
								var22, 0, 0, var19, var20);
					} else if (var5 == 8) {
						var26 = 8;
						var22 = var6.method2848(var0, var1, var2);
						if (var22 != 0) {
						...
						if (var8.animationId == -1 && var8.impostorIds == null) {
							...
							var28 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId, true,
									(Renderable) null);
							var29 = new DynamicObject(var3, 4, var25 + 4, var0, var1, var2, var8.animationId, true,
									(Renderable) null);
						}

						var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable) var28, (Renderable) var29, 256,
								var4, var26 * class61.field774[var4], var26 * class61.field775[var4], var19, var20);
					}
				}
			} else {
				if (var8.animationId == -1 && var8.impostorIds == null) {
					...
					var30 = new DynamicObject(var3, 10, var4, var0, var1, var2, var8.animationId, true,
							(Renderable) null);
				}

				if (var30 != null && var6.method2767(var0, var1, var2, var16, var9, var10, (Renderable) var30,
						var5 == 11 ? 256 : 0, var19, var20) && var8.clipped) {
					var22 = 15;
