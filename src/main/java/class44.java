...
public class class44 extends WorldMapData {
	...
	static boolean isFriended(String var0, boolean var1) {
		if (var0 == null) {
			...
			for (int var3 = 0; var3 < Client.friendCount; ++var3) {
				if (var2.equalsIgnoreCase(class207.method3989(Client.friends[var3].name, class5.field42))
						&& (!var1 || Client.friends[var3].world != 0)) {
					return true;
				}
			}
	...
	static final void method640() {
		for (PendingSpawn var0 = (PendingSpawn) Client.pendingSpawns
				.getFront(); var0 != null; var0 = (PendingSpawn) Client.pendingSpawns.getNext()) {
			if (var0.hitpoints > 0) {
				--var0.hitpoints;
			}
			...
			if (var0.hitpoints == 0) {
				...
				WorldMapType2.method519(var0.level, var0.type, var0.x, var0.y, var0.field1198, var0.field1199,
						var0.field1200);
				var0.unlink();
			} else {
				if (var0.delay > 0) {
				...
				if (var0.delay == 0 && var0.x >= 1 && var0.y >= 1 && var0.x <= 102 && var0.y <= 102) {
					...
					WorldMapType2.method519(var0.level, var0.type, var0.x, var0.y, var0.id, var0.orientation,
							var0.field1203);
					var0.delay = -1;
					if (var0.id == var0.field1198 && var0.field1198 == -1) {
						var0.unlink();
					} else if (var0.field1198 == var0.id && var0.field1199 == var0.orientation
							&& var0.field1203 == var0.field1200) {
						var0.unlink();
					}
				}
			}
	...
	static final int getSmoothNoise2D(int var0, int var1) {
		int var2 = Preferences.method1645(var0 - 1, var1 - 1) + Preferences.method1645(var0 + 1, var1 - 1)
				+ Preferences.method1645(var0 - 1, var1 + 1) + Preferences.method1645(var0 + 1, var1 + 1);
		int var3 = Preferences.method1645(var0 - 1, var1) + Preferences.method1645(var0 + 1, var1)
				+ Preferences.method1645(var0, var1 - 1) + Preferences.method1645(var0, var1 + 1);
