...
public class ClanMember extends Node {
	...
	static final void method1193(Widget var0, int var1, int var2, int var3) {
		...
		if (var4 != null) {
			...
			if (Client.field1183 != 2 && Client.field1183 != 5) {
				...
				BaseVarType.field33.method5186(var1, var2, var4.field2615, var4.field2611, var6, var7, var5, 256,
				...
				for (var10 = 0; var10 < var8; ++var10) {
					...
					if (var19 != null && var19.hasConfig() && !var19.hidden
							&& var19 != AbstractByteBuffer.localPlayer) {
						...
						boolean var20 = false;
						if (AbstractByteBuffer.localPlayer.team != 0 && var19.team != 0
								&& var19.team == AbstractByteBuffer.localPlayer.team) {
							var20 = true;
						}
				...
				if (Client.field938 != 0 && Client.gameCycle % 20 < 10) {
					...
					if (Client.field938 == 2) {
						var10 = Client.hintArrowX * 4 - WallObject.baseX * 4 + 2
								- AbstractByteBuffer.localPlayer.x / 32;
					...
					if (Client.field938 == 10 && Client.field940 >= 0
							&& Client.field940 < Client.cachedPlayers.length) {
				...
				if (!AbstractByteBuffer.localPlayer.hidden) {
					Rasterizer2D.method5129(var4.field2615 / 2 + var1 - 1, var4.field2611 / 2 + var2 - 1, 3, 3,
							16777215);
				}
			} else {
				...
				if (var0 == 6506) {
					...
					if (var0 == 6512) {
						...
						if (var0 == 6513) {
							...
							if (var9.method4528()) {
								class81.scriptStringStack[++class81.scriptStringStackSize - 1] = class72
										.getNpcDefinition(var7).method4742(var8, var9.field3389);
							} else {
								class81.intStack[++class81.intStackSize - 1] = class72.getNpcDefinition(var7)
										.method4731(var8, var9.field3392);
							}
							...
							var9 = class155.method3049(var8);
							if (var9.method4528()) {
								class81.scriptStringStack[++class81.scriptStringStackSize - 1] = Occluder
										.getObjectDefinition(var7).method4618(var8, var9.field3389);
							} else {
								class81.intStack[++class81.intStackSize - 1] = Occluder.getObjectDefinition(var7)
										.method4620(var8, var9.field3392);
							}
							...
							var9 = class155.method3049(var8);
							if (var9.method4528()) {
								class81.scriptStringStack[++class81.scriptStringStackSize - 1] = class46
										.getItemDefinition(var7).method4674(var8, var9.field3389);
							} else {
								class81.intStack[++class81.intStackSize - 1] = class46.getItemDefinition(var7)
										.method4667(var8, var9.field3392);
							}
							...
							var9 = class155.method3049(var8);
							if (var9.method4528()) {
								class81.scriptStringStack[++class81.scriptStringStackSize - 1] = BuildType
										.method4211(var7).method4551(var8, var9.field3389);
							} else {
								class81.intStack[++class81.intStackSize - 1] = BuildType.method4211(var7)
										.method4550(var8, var9.field3392);
							}
	...
	public static Permission[] method1195() {
		return new Permission[] { Permission.field3175, Permission.field3180, Permission.field3178,
				Permission.field3174, Permission.field3176, Permission.field3179 };
	}
