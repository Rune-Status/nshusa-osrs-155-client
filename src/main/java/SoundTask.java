				...
				if (var0.field3586) {
					if (!var0.field3588 || Client.field1081 == var1) {
						...
						if (var0.field3588 && Client.field1060) {
							class10.addMenuEntry("Examine", class60.getColTags(16776960) + var4, 1003, var1, var2,
									var3);
						}

						if (Client.itemSelectionState == 1) {
							class10.addMenuEntry("Use",
									Client.field1067 + " " + "->" + " " + class60.getColTags(16776960) + var4, 7, var1,
									var2, var3);
						} else if (Client.spellSelected) {
							if ((WorldMapType1.field451 & 2) == 2) {
								class10.addMenuEntry(Client.field1071,
										Client.field948 + " " + "->" + " " + class60.getColTags(16776960) + var4, 8,
										var1, var2, var3);
							}
						} else {
							...
							if (var11 != null) {
								for (var7 = 4; var7 >= 0; --var7) {
									if (var11[var7] != null && !var11[var7].equalsIgnoreCase("Attack")) {
										...
										class10.addMenuEntry(var11[var7], class60.getColTags(16776960) + var4, var8,
												var1, var2, var3);
									}
								}
							}
								...
								for (var7 = 4; var7 >= 0; --var7) {
									if (var11[var7] != null && var11[var7].equalsIgnoreCase("Attack")) {
										...
										if (class89.field1403 != Client.field947) {
											if (class89.field1401 == Client.field947
