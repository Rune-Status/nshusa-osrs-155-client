...
public class class45 extends class28 {
	...
	boolean method643(int var1, int var2) {
		return var1 < this.field603 * 8 ? false
				: (var2 < this.field606 * 8 ? false
						: (var1 >= this.field603 * 8 + 8 ? false : var2 < this.field606 * 8 + 8));
	}
	...
	void method641(Buffer var1, Buffer var2) {
		...
		if (var3 != class36.field524.field523) {
			...
			if (var3 != class35.field512.field513) {
				...
				if (var4 == super.field416 && var5 == super.field417 && var6 == this.field603
						&& var7 == this.field606) {
	...
	public boolean equals(Object var1) {
		if (!(var1 instanceof class45)) {
			...
			return var2.field416 == super.field416 && var2.field417 == super.field417
					? this.field603 == var2.field603 && this.field606 == var2.field606
					: false;
		}
	}
	...
	public static int method667(int var0, int var1, int var2, class163 var3, CollisionData var4, boolean var5,
			int[] var6, int[] var7) {
		int var9;
		...
		if (var2 == 1) {
			...
			while (true) {
				...
				if (var30 > 0 && class162.field2309[var30 - 1][var31] == 0
				...
				if (var30 < 127 && class162.field2309[var30 + 1][var31] == 0
				...
				if (var31 > 0 && class162.field2309[var30][var31 - 1] == 0
				...
				if (var31 < 127 && class162.field2309[var30][var31 + 1] == 0
				...
				if (var30 > 0 && var31 > 0 && class162.field2309[var30 - 1][var31 - 1] == 0
				...
				if (var30 < 127 && var31 > 0 && class162.field2309[var30 + 1][var31 - 1] == 0
						&& 0 == (var18[var19 + 1][var20 - 1] & 19136899) && (var18[var19 + 1][var20] & 19136896) == 0
						&& (var18[var19][var20 - 1] & 19136770) == 0) {
					class162.field2313[var33] = var10 + 1;
					class162.field2314[var33] = var11 - 1;
					var33 = var33 + 1 & 4095;
				...
				if (var30 > 0 && var31 < 127 && 0 == class162.field2309[var30 - 1][var31 + 1]
						&& 0 == (var18[var19 - 1][var20 + 1] & 19136824) && (var18[var19 - 1][var20] & 19136776) == 0
						&& (var18[var19][var20 + 1] & 19136800) == 0) {
					class162.field2313[var33] = var10 - 1;
					class162.field2314[var33] = var11 + 1;
					var33 = var33 + 1 & 4095;
				...
				if (var30 < 127 && var31 < 127 && 0 == class162.field2309[var30 + 1][var31 + 1]
						&& (var18[var19 + 1][var20 + 1] & 19136992) == 0 && 0 == (var18[var19 + 1][var20] & 19136896)
						&& (var18[var19][var20 + 1] & 19136800) == 0) {
					class162.field2313[var33] = var10 + 1;
					class162.field2314[var33] = var11 + 1;
					var33 = var33 + 1 & 4095;
			...
			while (true) {
				...
				var21 = class162.field2307[var30][var31] + 1;
				if (var30 > 0 && class162.field2309[var30 - 1][var31] == 0 && (var18[var19 - 1][var20] & 19136782) == 0
						&& (var18[var19 - 1][var20 + 1] & 19136824) == 0) {
					class162.field2313[var33] = var10 - 1;
					class162.field2314[var33] = var11;
					var33 = var33 + 1 & 4095;
					class162.field2309[var30 - 1][var31] = 2;
				...
				if (var30 < 126 && 0 == class162.field2309[var30 + 1][var31]
						&& (var18[var19 + 2][var20] & 19136899) == 0 && (var18[var19 + 2][var20 + 1] & 19136992) == 0) {
					class162.field2313[var33] = var10 + 1;
					class162.field2314[var33] = var11;
					var33 = var33 + 1 & 4095;
					class162.field2309[var30 + 1][var31] = 8;
				...
				if (var31 > 0 && class162.field2309[var30][var31 - 1] == 0 && (var18[var19][var20 - 1] & 19136782) == 0
						&& (var18[var19 + 1][var20 - 1] & 19136899) == 0) {
					class162.field2313[var33] = var10;
					class162.field2314[var33] = var11 - 1;
					var33 = var33 + 1 & 4095;
					class162.field2309[var30][var31 - 1] = 1;
				...
				if (var31 < 126 && class162.field2309[var30][var31 + 1] == 0
						&& (var18[var19][var20 + 2] & 19136824) == 0 && (var18[var19 + 1][var20 + 2] & 19136992) == 0) {
					class162.field2313[var33] = var10;
					class162.field2314[var33] = var11 + 1;
					var33 = var33 + 1 & 4095;
					class162.field2309[var30][var31 + 1] = 4;
				...
				if (var30 < 126 && var31 > 0 && class162.field2309[var30 + 1][var31 - 1] == 0
						&& (var18[var19 + 1][var20 - 1] & 19136911) == 0
						&& (var18[var19 + 2][var20 - 1] & 19136899) == 0 && 0 == (var18[var19 + 2][var20] & 19136995)) {
					class162.field2313[var33] = var10 + 1;
					class162.field2314[var33] = var11 - 1;
					var33 = var33 + 1 & 4095;
					class162.field2309[var30 + 1][var31 - 1] = 9;
				...
				if (var30 > 0 && var31 < 126 && class162.field2309[var30 - 1][var31 + 1] == 0
						&& 0 == (var18[var19 - 1][var20 + 1] & 19136830)
						&& (var18[var19 - 1][var20 + 2] & 19136824) == 0 && 0 == (var18[var19][var20 + 2] & 19137016)) {
					class162.field2313[var33] = var10 - 1;
					class162.field2314[var33] = var11 + 1;
					var33 = var33 + 1 & 4095;
					class162.field2309[var30 - 1][var31 + 1] = 6;
				...
				if (var30 < 126 && var31 < 126 && 0 == class162.field2309[var30 + 1][var31 + 1]
						&& (var18[var19 + 1][var20 + 2] & 19137016) == 0
			...
			label840: while (true) {
				label838: while (true) {
						...
						do {
							do {
								label815: do {
									...
									var21 = class162.field2307[var30][var31] + 1;
									if (var30 > 0 && class162.field2309[var30 - 1][var31] == 0
											&& (var18[var19 - 1][var20] & 19136782) == 0
											&& 0 == (var18[var19 - 1][var20 + var2 - 1] & 19136824)) {
										var22 = 1;
									...
									if (var30 < 128 - var2 && 0 == class162.field2309[var30 + 1][var31]
											&& 0 == (var18[var19 + var2][var20] & 19136899)
											&& (var18[var19 + var2][var20 + var2 - 1] & 19136992) == 0) {
										var22 = 1;
									...
									if (var31 > 0 && class162.field2309[var30][var31 - 1] == 0
											&& (var18[var19][var20 - 1] & 19136782) == 0
											&& (var18[var19 + var2 - 1][var20 - 1] & 19136899) == 0) {
										var22 = 1;
									...
									if (var31 < 128 - var2 && 0 == class162.field2309[var30][var31 + 1]
											&& (var18[var19][var20 + var2] & 19136824) == 0
											&& (var18[var19 + var2 - 1][var20 + var2] & 19136992) == 0) {
										var22 = 1;
									...
									if (var30 > 0 && var31 > 0 && class162.field2309[var30 - 1][var31 - 1] == 0
											&& (var18[var19 - 1][var20 - 1] & 19136782) == 0) {
										var22 = 1;
										...
										while (true) {
											...
											if ((var18[var19 - 1][var22 + (var20 - 1)] & 19136830) != 0
													|| (var18[var22 + (var19 - 1)][var20 - 1] & 19136911) != 0) {
												break;
											}
									...
									if (var30 < 128 - var2 && var31 > 0 && class162.field2309[var30 + 1][var31 - 1] == 0
											&& (var18[var19 + var2][var20 - 1] & 19136899) == 0) {
										var22 = 1;
										...
										while (true) {
											...
											if (0 != (var18[var19 + var2][var22 + (var20 - 1)] & 19136995)
													|| (var18[var19 + var22][var20 - 1] & 19136911) != 0) {
												break;
											}
									...
									if (var30 > 0 && var31 < 128 - var2 && class162.field2309[var30 - 1][var31 + 1] == 0
											&& 0 == (var18[var19 - 1][var20 + var2] & 19136824)) {
										for (var22 = 1; var22 < var2; ++var22) {
											if ((var18[var19 - 1][var22 + var20] & 19136830) != 0
													|| (var18[var22 + (var19 - 1)][var20 + var2] & 19137016) != 0) {
												continue label815;
											}
										}
					...
					for (var22 = 1; var22 < var2; ++var22) {
						if ((var18[var19 + var22][var20 + var2] & 19137016) != 0
								|| (var18[var19 + var2][var22 + var20] & 19136995) != 0) {
							continue label838;
						}
					}
		...
		if (!var28) {
			...
			for (var20 = var33 - var32; var20 <= var32 + var33; ++var20) {
				for (var21 = var17 - var32; var21 <= var32 + var17; ++var21) {
					...
					if (var22 >= 0 && var23 >= 0 && var22 < 128 && var23 < 128
							&& class162.field2307[var22][var23] < 100) {
						int var24 = 0;
						if (var20 < var33) {
							var24 = var33 - var20;
		...
		if (var0 == var11 && var30 == var1) {
			...
			for (var14 = var15 = class162.field2309[var11 - var9][var30 - var10]; var0 != var11
					|| var30 != var1; var14 = class162.field2309[var11 - var9][var30 - var10]) {
				if (var15 != var14) {
					var15 = var14;
