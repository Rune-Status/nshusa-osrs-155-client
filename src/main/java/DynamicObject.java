...
public class DynamicObject extends Renderable {
	...
	protected final Model getModel() {
		...
		if (var12 == null) {
			...
			return var12.method4615(this.type, this.orientation, var8, var10, var9, var11, this.field1534,
					this.field1535);
		}
	}
						...
						if (var5 > 0) {
							...
							if (var6 == RSCanvas.field678.offset) {
								if (16711935L == class238.currentRequest.hash) {
									...
									class238.currentRequest.index.method4318(
											(int) (class238.currentRequest.hash & 65535L), RSCanvas.field678.payload,
											16711680L == (class238.currentRequest.hash & 16711680L),
											class238.field3263);
								}
