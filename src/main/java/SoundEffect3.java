public class SoundEffect3 {
	...
	float interpolateMagniture(int var1, int var2, float var3) {
		float var4 = (float) this.magnitudes[var1][0][var2]
				+ var3 * (float) (this.magnitudes[var1][1][var2] - this.magnitudes[var1][0][var2]);
		var4 *= 0.0015258789F;
	...
	float interpolatePhase(int var1, int var2, float var3) {
		float var4 = (float) this.phases[var1][0][var2]
				+ var3 * (float) (this.phases[var1][1][var2] - this.phases[var1][0][var2]);
		var4 *= 1.2207031E-4F;
	...
	int compute(int var1, float var2) {
		...
		if (this.pairs[var1] == 0) {
			...
			minimisedCoefficients[var1][0] = -2.0F * var3
					* (float) Math.cos((double) this.interpolatePhase(var1, 0, var2));
			...
			for (var4 = 1; var4 < this.pairs[var1]; ++var4) {
				...
				minimisedCoefficients[var1][var4 * 2] = minimisedCoefficients[var1][var4 * 2 - 1] * var5
						+ minimisedCoefficients[var1][var4 * 2 - 2] * var6;

				for (int var7 = var4 * 2 - 1; var7 >= 2; --var7) {
					minimisedCoefficients[var1][var7] += minimisedCoefficients[var1][var7 - 1] * var5
							+ minimisedCoefficients[var1][var7 - 2] * var6;
				}
