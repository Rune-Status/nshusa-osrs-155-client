...
final class class17 implements Comparator {
	...
	static final void method127() {
		for (GraphicsObject var0 = (GraphicsObject) Client.graphicsObjectDeque
				.getFront(); var0 != null; var0 = (GraphicsObject) Client.graphicsObjectDeque.getNext()) {
	...
	static final void method128(Actor var0) {
		if (var0.field1254 == Client.gameCycle || var0.animation == -1 || var0.actionAnimationDisable != 0
				|| var0.field1207 + 1 > class204.getAnimation(var0.animation).frameLenghts[var0.actionFrame]) {
	...
	static final void method129(int var0, int var1, int var2, int var3, int var4, int var5, int var6, Region var7,
			CollisionData var8) {
		...
		if (var6 == 22) {
			...
			if (var6 >= 12) {
				if (var9.animationId == -1 && var9.impostorIds == null) {
					...
					var22 = new DynamicObject(var4, var6, var5, var1, var2, var3, var9.animationId, true,
							(Renderable) null);
				}
				...
				if (var9.animationId == -1 && var9.impostorIds == null) {
					...
					var22 = new DynamicObject(var4, 0, var5, var1, var2, var3, var9.animationId, true,
							(Renderable) null);
				}

				var7.addBoundary(var0, var2, var3, var17, (Renderable) var22, (Renderable) null, class61.field783[var5],
						0, var20, var21);
				if (var9.interactType != 0) {
				...
				if (var9.animationId == -1 && var9.impostorIds == null) {
					...
					var22 = new DynamicObject(var4, 1, var5, var1, var2, var3, var9.animationId, true,
							(Renderable) null);
				}

				var7.addBoundary(var0, var2, var3, var17, (Renderable) var22, (Renderable) null, class61.field771[var5],
						0, var20, var21);
				if (var9.interactType != 0) {
					var8.addWall(var2, var3, var6, var5, var9.field3456);
				}
				...
				if (var6 == 2) {
					...
					if (var9.animationId == -1 && var9.impostorIds == null) {
						...
						var23 = new DynamicObject(var4, 2, var5 + 4, var1, var2, var3, var9.animationId, true,
								(Renderable) null);
						var24 = new DynamicObject(var4, 2, var27, var1, var2, var3, var9.animationId, true,
								(Renderable) null);
					}

					var7.addBoundary(var0, var2, var3, var17, (Renderable) var23, (Renderable) var24,
							class61.field783[var5], class61.field783[var27], var20, var21);
					if (var9.interactType != 0) {
						var8.addWall(var2, var3, var6, var5, var9.field3456);
					}
					...
					if (var9.animationId == -1 && var9.impostorIds == null) {
						...
						var22 = new DynamicObject(var4, 3, var5, var1, var2, var3, var9.animationId, true,
								(Renderable) null);
					}

					var7.addBoundary(var0, var2, var3, var17, (Renderable) var22, (Renderable) null,
							class61.field771[var5], 0, var20, var21);
					if (var9.interactType != 0) {
						var8.addWall(var2, var3, var6, var5, var9.field3456);
					}
					...
					if (var9.animationId == -1 && var9.impostorIds == null) {
						...
						var22 = new DynamicObject(var4, 4, var5, var1, var2, var3, var9.animationId, true,
								(Renderable) null);
					}

					var7.addBoundaryDecoration(var0, var2, var3, var17, (Renderable) var22, (Renderable) null,
							class61.field783[var5], 0, 0, 0, var20, var21);
				} else {
					int var28;
					if (var6 == 5) {
						var27 = 16;
						...
						if (var9.animationId == -1 && var9.impostorIds == null) {
							...
							var24 = new DynamicObject(var4, 4, var5, var1, var2, var3, var9.animationId, true,
									(Renderable) null);
						}

						var7.addBoundaryDecoration(var0, var2, var3, var17, (Renderable) var24, (Renderable) null,
								class61.field783[var5], 0, var27 * class61.field782[var5],
								var27 * class61.field770[var5], var20, var21);
					} else if (var6 == 6) {
						var27 = 8;
						var28 = var7.method2848(var0, var2, var3);
						if (var28 != 0) {
						...
						if (var9.animationId == -1 && var9.impostorIds == null) {
							...
							var24 = new DynamicObject(var4, 4, var5 + 4, var1, var2, var3, var9.animationId, true,
									(Renderable) null);
						}

						var7.addBoundaryDecoration(var0, var2, var3, var17, (Renderable) var24, (Renderable) null, 256,
								var5, var27 * class61.field774[var5], var27 * class61.field775[var5], var20, var21);
					} else if (var6 == 7) {
						var28 = var5 + 2 & 3;
						if (var9.animationId == -1 && var9.impostorIds == null) {
							var22 = var9.method4614(4, var28 + 4, var16, var18, var17, var19);
						} else {
							var22 = new DynamicObject(var4, 4, var28 + 4, var1, var2, var3, var9.animationId, true,
									(Renderable) null);
						}

						var7.addBoundaryDecoration(var0, var2, var3, var17, (Renderable) var22, (Renderable) null, 256,
								var28, 0, 0, var20, var21);
					} else if (var6 == 8) {
						var27 = 8;
						var28 = var7.method2848(var0, var2, var3);
						if (var28 != 0) {
						...
						if (var9.animationId == -1 && var9.impostorIds == null) {
							...
							var24 = new DynamicObject(var4, 4, var5 + 4, var1, var2, var3, var9.animationId, true,
									(Renderable) null);
							var25 = new DynamicObject(var4, 4, var26 + 4, var1, var2, var3, var9.animationId, true,
									(Renderable) null);
						}

						var7.addBoundaryDecoration(var0, var2, var3, var17, (Renderable) var24, (Renderable) var25, 256,
								var5, var27 * class61.field774[var5], var27 * class61.field775[var5], var20, var21);
					}
				}
			}
			...
			if (var22 != null) {
				var7.method2767(var0, var2, var3, var17, var10, var11, (Renderable) var22, var6 == 11 ? 256 : 0, var20,
						var21);
			}
