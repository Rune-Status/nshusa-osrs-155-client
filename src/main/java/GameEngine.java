...
public abstract class GameEngine extends Applet implements Runnable, FocusListener, WindowListener {
	...
	final synchronized void method1014() {
		...
		this.field712 = true;
		if (class12.field275 != null && class60.canvasWidth == class12.field275.width
				&& class48.canvasHeight == class12.field275.height) {
	...
	protected final void drawLoadingScreen(int var1, String var2, boolean var3) {
		try {
			...
			try {
				...
				var4.drawImage(class48.field637, class60.canvasWidth / 2 - 152, class48.canvasHeight / 2 - 18,
						(ImageObserver) null);
