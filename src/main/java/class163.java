				...
				if (var0 == 6606) {
					...
					if (var0 == 6611) {
						...
						if (var13 == null) {
							...
							class81.intStack[++class81.intStackSize - 1] = (var13.method290() - var13.method316() + 1)
									* 64;
							class81.intStack[++class81.intStackSize - 1] = (var13.method323() - var13.method333() + 1)
									* 64;
						}
						...
						if (var0 == 6618) {
							...
							if (var0 == 6619) {
								...
								if (var11 == null) {
									...
									class81.intStack[++class81.intStackSize - 1] = var11.method272(var12.plane,
											var12.worldX, var12.worldY) ? 1 : 0;
									return 1;
								}
							} else if (var0 == 6622) {
								...
								if (var0 == 6628) {
									...
									if (var0 == 6633) {
										...
										class81.intStack[++class81.intStackSize - 1] = Friend.method1134().method5362()
												? 1
												: 0;
										return 1;
									} else if (var0 == 6636) {
										var3 = class81.intStack[--class81.intStackSize];
										class81.intStack[++class81.intStackSize - 1] = Friend.method1134()
												.method5363(var3) ? 1 : 0;
										return 1;
									} else if (var0 == 6637) {
										var3 = class81.intStack[--class81.intStackSize];
										...
										if (var0 == 6639) {
											...
											if (var8 == null) {
												...
												class81.intStack[++class81.intStackSize - 1] = var8.field547
														.method4058();
											}
											...
											if (var0 == 6693) {
												...
												class81.intStack[++class81.intStackSize
														- 1] = class147.field2194.field623;
												return 1;
											} else if (var0 == 6698) {
												class81.intStack[++class81.intStackSize
														- 1] = class147.field2194.field621.method4058();
												return 1;
											} else if (var0 == 6699) {
												class81.intStack[++class81.intStackSize
														- 1] = class147.field2194.field620.method4058();
												return 1;
											} else {
												return 2;
											}
