public final class SpritePixels extends Rasterizer2D {
	...
	public void method5172(int var1, int var2) {
		var1 += this.offsetX;
		var2 += this.offsetY;
		...
		if (var6 > 0 && var5 > 0) {
			method5254(Rasterizer2D.graphicsPixels, this.image, 0, var4, var3, var6, var5, var7, var8);
		}
	}

	void method5189(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) {
			var1 -= this.offsetX << 4;
			var2 -= this.offsetY << 4;
					...
					if (var27 == 0) {
						if (var26 == 0) {
							for (var33 = var22; var33 < 0; var23 += Rasterizer2D.graphicsPixelsWidth) {
								...
								var36 = var31;
								var37 = var20;
								if (var30 >= 0 && var31 >= 0 && var30 - (this.width << 12) < 0
										&& var31 - (this.height << 12) < 0) {
									for (; var37 < 0; ++var37) {
	...
	public void method5194(int var1, int var2, int var3, int var4) {
		if (var3 > 0 && var4 > 0) {
			int var5 = this.width;
			...
			method5178(Rasterizer2D.graphicsPixels, this.image, 0, var7, var8, var13, var14, var3, var4, var11, var12,
					var5);
		}
	}
	...
	public void method5190(int var1, int var2, int var3, int var4) {
		if (var3 <= this.maxWidth && var4 <= this.maxHeight) {
			...
			int var6 = var1 + (var3 * (this.offsetX + this.width) + this.maxWidth - 1) / this.maxWidth;
			int var7 = var2 + var4 * this.offsetY / this.maxHeight;
			int var8 = var2 + ((this.offsetY + this.height) * var4 + this.maxHeight - 1) / this.maxHeight;
			...
			if (var5 < var6 && var7 < var8) {
				int var9 = var7 * Rasterizer2D.graphicsPixelsWidth + var5;
	...
	public void method5173(int var1, int var2) {
		var1 += this.offsetX;
		var2 += this.offsetY;
		int var3 = var1 + var2 * Rasterizer2D.graphicsPixelsWidth;
		int var4 = 0;
		...
		if (var6 > 0 && var5 > 0) {
			method5206(Rasterizer2D.graphicsPixels, this.image, var4, var3, var6, var5, var7, var8);
		}
	}
	...
	public SpritePixels copy() {
		...
		for (int var2 = 0; var2 < this.height; ++var2) {
			for (int var3 = 0; var3 < this.width; ++var3) {
				var1.image[var3 + (var2 + this.offsetY) * this.maxWidth + this.offsetX] = this.image[var3
						+ var2 * this.width];
			}
		}
	...
	public void method5168(int var1) {
		if (this.width != this.maxWidth || this.height != this.maxHeight) {
			...
			for (int var9 = 0; var9 < this.height; ++var9) {
				for (int var10 = 0; var10 < this.width; ++var10) {
					var8[(var9 + var4) * var6 + var10 + var2] = this.image[var10 + var9 * this.width];
				}
			}
	...
	public void method5171(int var1) {
	...
	public void method5186(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9,
			int[] var10) {
		try {
			int var11 = -var3 / 2;
			int var12 = -var4 / 2;
	...
	public void method5183(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			int var6 = this.width;
			...
			method5184(Rasterizer2D.graphicsPixels, this.image, 0, var8, var9, var14, var15, var3, var4, var12, var13,
					var6, var5);
		}
	}

	public void method5188(int var1, int var2, int var3, int var4) {
		this.method5189(this.maxWidth << 3, this.maxHeight << 3, var1 << 4, var2 << 4, var3, var4);
	}
	...
	public void method5174() {
		if (this.width != this.maxWidth || this.height != this.maxHeight) {
			...
			for (int var2 = 0; var2 < this.height; ++var2) {
				for (int var3 = 0; var3 < this.width; ++var3) {
					var1[(var2 + this.offsetY) * this.maxWidth + var3 + this.offsetX] = this.image[var3
							+ var2 * this.width];
				}
			}
	...
	public void method5181(int var1, int var2, int var3) {
		var1 += this.offsetX;
		var2 += this.offsetY;
		...
		if (var7 > 0 && var6 > 0) {
			method5182(Rasterizer2D.graphicsPixels, this.image, 0, var5, var4, var7, var6, var8, var9, var3);
		}
	}

	public SpritePixels method5222() {
	...
	public void method5185(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
		...
		int var13 = var3 + var1 + var11 + (var9 + var2 + var4) * Rasterizer2D.graphicsPixelsWidth;
		int var14 = var9 + var2;
	...
	public void method5187(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
		try {
			int var10 = -var3 / 2;
			int var11 = -var4 / 2;
	...
	public void method5179(int var1, int var2, int var3, int var4) {
		if (var3 == 256) {
			this.method5172(var1, var2);
		} else {
			var1 += this.offsetX;
			var2 += this.offsetY;
			...
			if (var8 > 0 && var7 > 0) {
				method5180(Rasterizer2D.graphicsPixels, this.image, 0, var6, var5, var8, var7, var9, var10, var3, var4);
			}
		}
	}

	static void method5206(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
	...
	static void method5182(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9) {
		int var10 = 256 - var9;
		...
		for (int var11 = -var6; var11 < 0; ++var11) {
			for (int var12 = -var5; var12 < 0; ++var12) {
				...
				if (var2 != 0) {
					int var13 = var0[var4];
					var0[var4++] = (var9 * (var2 & 16711935) + (var13 & 16711935) * var10 & -16711936)
							+ ((var2 & '\uff00') * var9 + var10 * (var13 & '\uff00') & 16711680) >> 8;
				} else {
					++var4;
				}
			}
	...
	static void method5254(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
			int var8) {
		int var9 = -(var5 >> 2);
		var5 = -(var5 & 3);
	...
	static void method5180(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10) {
		int var11 = 256 - var9;
	...
	static void method5184(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
		...
		for (int var15 = -var8; var15 < 0; ++var15) {
			...
			for (int var17 = -var7; var17 < 0; ++var17) {
				...
				if (var2 != 0) {
					int var18 = var0[var5];
					var0[var5++] = ((var18 & 16711935) * var13 + var12 * (var2 & 16711935) & -16711936)
							+ ((var2 & '\uff00') * var12 + var13 * (var18 & '\uff00') & 16711680) >> 8;
				} else {
					++var5;
				}
	...
	static void method5178(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
