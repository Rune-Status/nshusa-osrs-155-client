public final class ItemLayer {
	...
	static void method2496(GameEngine var0) {
		...
		if (class90.worldSelectShown) {
			if (MouseInput.field741 == 1 || !class110.field1650 && MouseInput.field741 == 4) {
				...
				if (MouseInput.field752 >= var1 && MouseInput.field752 <= var1 + 14 && MouseInput.field753 >= 4
						&& MouseInput.field753 <= 18) {
					class46.method678(0, 0);
				} else if (MouseInput.field752 >= var1 + 15 && MouseInput.field752 <= var1 + 80
						&& MouseInput.field753 >= 4 && MouseInput.field753 <= 18) {
					class46.method678(0, 1);
				} else {
					var2 = class90.field1419 + 390;
					if (MouseInput.field752 >= var2 && MouseInput.field752 <= var2 + 14 && MouseInput.field753 >= 4
							&& MouseInput.field753 <= 18) {
						class46.method678(1, 0);
					} else if (MouseInput.field752 >= var2 + 15 && MouseInput.field752 <= var2 + 80
							&& MouseInput.field753 >= 4 && MouseInput.field753 <= 18) {
						class46.method678(1, 1);
					} else {
						var3 = class90.field1419 + 500;
						if (MouseInput.field752 >= var3 && MouseInput.field752 <= var3 + 14 && MouseInput.field753 >= 4
								&& MouseInput.field753 <= 18) {
							class46.method678(2, 0);
						} else if (MouseInput.field752 >= var3 + 15 && MouseInput.field752 <= var3 + 80
								&& MouseInput.field753 >= 4 && MouseInput.field753 <= 18) {
							class46.method678(2, 1);
						} else {
							var14 = class90.field1419 + 610;
							if (MouseInput.field752 >= var14 && MouseInput.field752 <= var14 + 14
									&& MouseInput.field753 >= 4 && MouseInput.field753 <= 18) {
								class46.method678(3, 0);
							} else if (MouseInput.field752 >= var14 + 15 && MouseInput.field752 <= var14 + 80
									&& MouseInput.field753 >= 4 && MouseInput.field753 <= 18) {
								class46.method678(3, 1);
							} else if (MouseInput.field752 >= class90.field1419 + 708 && MouseInput.field753 >= 4
									&& MouseInput.field752 <= class90.field1419 + 708 + 50
									&& MouseInput.field753 <= 20) {
								...
								class90.logoSprite
										.method5147(class90.field1419 + 382 - class90.logoSprite.originalWidth / 2, 18);
			...
			if ((MouseInput.field741 == 1 || !class110.field1650 && MouseInput.field741 == 4)
					&& MouseInput.field752 >= class90.field1419 + 765 - 50 && MouseInput.field753 >= 453) {
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					if (Client.languageId == 0) {
						if (MouseInput.field741 == 1 || !class110.field1650 && MouseInput.field741 == 4) {
							...
							byte var12 = 100;
							byte var4 = 35;
							if (MouseInput.field752 >= var1 && MouseInput.field752 <= var1 + var12
									&& MouseInput.field753 >= var11 && MouseInput.field753 <= var4 + var11) {
					...
					if (class90.loginIndex == 0) {
						...
						var6 = 291;
						if (var1 == 1 && var2 >= var10 - 75 && var2 <= var10 + 75 && var3 >= var6 - 20
								&& var3 <= var6 + 20) {
							ClanMember.method1197(class44.method637("secure", true)
						...
						if (class90.loginIndex != 1) {
							...
							if (class90.loginIndex == 2) {
								...
								if (var1 == 1 && var3 >= var15 - 15 && var3 < var15) {
									class1.method3("Please enter your username.",
								...
								var6 = 277;
								class90.field1435 = var2 >= var10 && var2 < var10 + CacheFile.field1750 && var3 >= var6
										&& var3 < var6 + Spotanim.field3336;
								...
								var6 = 277;
								class90.field1436 = var2 >= var10 && var2 < var10 + CacheFile.field1750 && var3 >= var6
										&& var3 < var6 + Spotanim.field3336;
								...
								while (true) {
									while (class1.method0()) {
										...
										for (int var8 = 0; var8 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
												.length(); ++var8) {
											if (ChatLineBuffer.field1546 == "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
													.charAt(var8)) {
												var7 = true;
												break;
											}
										...
										if (class94.field1491 == 13) {
											...
											if (class94.field1491 == 85 && class90.username.length() > 0) {
												class90.username = class90.username.substring(0,
														class90.username.length() - 1);
											}
											...
											if (class94.field1491 == 85 && class90.password.length() > 0) {
												class90.password = class90.password.substring(0,
														class90.password.length() - 1);
											}
								...
								var18 = 276;
								if (var1 == 1 && var2 >= var14 - 75 && var2 <= var14 + 75 && var3 >= var18 - 20
										&& var3 <= var18 + 20) {
									class46.method714(false);
								}
								...
								if (class90.loginIndex == 4) {
									...
									if (var1 == 1 && var2 >= class90.loginWindowX + 180 - 9
											&& var2 <= class90.loginWindowX + 180 + 130 && var3 >= 263 && var3 <= 296) {
										class90.field1438 = !class90.field1438;
									}

									if (var1 == 1 && var2 >= class90.loginWindowX + 180 - 34
											&& var2 <= class90.loginWindowX + 34 + 180 && var3 >= 351 && var3 <= 363) {
										ClanMember.method1197(class44.method637("secure", true)
									...
									while (class1.method0()) {
										...
										if (class94.field1491 == 13) {
											...
											if (class94.field1491 == 85 && class90.field1437.length() > 0) {
												class90.field1437 = class90.field1437.substring(0,
														class90.field1437.length() - 1);
											}
									...
									while (class1.method0()) {
										...
										for (var17 = 0; var17 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
												.length(); ++var17) {
											if (ChatLineBuffer.field1546 == "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| "
													.charAt(var17)) {
												var16 = true;
	...
	static void method2495() {
		for (WidgetNode var0 = (WidgetNode) Client.componentTable
				.method3646(); var0 != null; var0 = (WidgetNode) Client.componentTable.method3647()) {
			int var1 = var0.id;
