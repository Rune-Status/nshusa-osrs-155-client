...
public final class Player extends Actor {
	...
	protected final Model getModel() {
		if (this.composition == null) {
			...
			Sequence var1 = super.animation != -1 && super.actionAnimationDisable == 0
					? class204.getAnimation(super.animation)
					: null;
			Sequence var2 = super.poseAnimation == -1 || this.field901
					|| super.idlePoseAnimation == super.poseAnimation && var1 != null ? null
							: class204.getAnimation(super.poseAnimation);
			...
			if (var3 == null) {
				...
				if (!this.field901 && this.model != null) {
					...
					if (Client.gameCycle >= this.field891 && Client.gameCycle < this.field892) {
						var4 = this.model;
						var4.method2665(this.field906 - super.x, this.field897 - this.field890,
								this.field884 - super.y);
						...
						var4.method2665(super.x - this.field906, this.field890 - this.field897,
								super.y - this.field884);
					}
				}
	...
	int getSize() {
		return this.composition != null && this.composition.transformedNpcId != -1
				? class72.getNpcDefinition(this.composition.transformedNpcId).field3559
				: 1;
	}
																														...
																														if (var7 < 100) {
																															if (var7 != 0) {
																																if (var7 != 1) {
																																													...
																																													if (var7 != 33) {
																																														if (var7 != 34) {
																																															if (var7 != 35) {
																																																			...
																																																			if (var7 != 39) {
																																																				if (var7 != 40) {
																																																					if (var7 != 42) {
																																																						if (var7 != 43) {
																																																							if (var7 == 44) {
																																																								...
																																																								if (var12 < 0
																																																										|| var12 >= class81.field1332[var11]) {
																																																									throw new RuntimeException();
																																																								}

																																																								class81.intStack[++class81.intStackSize
																																																										- 1] = class81.SHAPE_VERTICES[var11][var12];
																																																							} else if (var7 == 46) {
																																																								var11 = var39[var22];
																																																								...
																																																								class81.SHAPE_VERTICES[var11][var12] = class81.intStack[class81.intStackSize
																																																										+ 1];
																																																							} else if (var7 == 47) {
																																																								var24 = GZipDecompressor.chatMessages
																																																										.getVarcString(
																																																												var39[var22]);
																																																								if (var24 == null) {
																																																									var24 = "null";
																																																								...
																																																								class81.scriptStringStack[++class81.scriptStringStackSize
																																																										- 1] = var24;
																																																							} else if (var7 == 48) {
																																																								GZipDecompressor.chatMessages
																																																										.putVarcString(
																																																												var39[var22],
																																																												class81.scriptStringStack[--class81.scriptStringStackSize]);
																																																							} else {
																																																								...
																																																								IntegerNode var70 = (IntegerNode) var53
																																																										.get((long) class81.intStack[--class81.intStackSize]);
																																																								if (var70 != null) {
																																																									var22 += var70.value;
																																																								}
																																																							}
																																																						...
																																																						class81.intStack[++class81.intStackSize
																																																								- 1] = GZipDecompressor.chatMessages
																																																										.getVarc(
																																																												var39[var22]);
																																																					}
																																																				} else {
																																																					var11 = var39[var22];
																																																					Script var63 = (Script) Script.field1518
																																																							.get((long) var11);
																																																					Script var66;
																																																					if (var63 != null) {
																																																						var66 = var63;
																																																					} else {
																																																						byte[] var68 = class51.indexScripts
																																																								.getConfigData(
																																																										var11,
																																																										0);
																																																						if (var68 == null) {
																																																					...
																																																					for (var16 = 0; var16 < var63.intStackCount; ++var16) {
																																																						var69[var16] = class81.intStack[var16
																																																								+ (class81.intStackSize
																																																										- var63.intStackCount)];
																																																					}

																																																					for (var16 = 0; var16 < var63.stringStackCount; ++var16) {
																																																						var65[var16] = class81.scriptStringStack[var16
																																																								+ (class81.scriptStringStackSize
																																																										- var63.stringStackCount)];
																																																					}
																																																					...
																																																					class81.scriptStack[++class81.scriptStackCount
																																																							- 1] = var64;
																																																					var3 = var63;
																																																...
																																																class81.scriptStringStack[++class81.scriptStringStackSize
																																																		- 1] = FileOnDisk.scriptLocalStrings[var39[var22]];
																																															}
																																														} else {
																																														...
																																														class81.intStack[++class81.intStackSize
																																																- 1] = class81.scriptLocalInts[var39[var22]];
																																													}
																																												} else {
																																													class81.intStackSize -= 2;
																																													if (class81.intStack[class81.intStackSize] >= class81.intStack[class81.intStackSize
																																															+ 1]) {
																																														var22 += var39[var22];
																																													}
																																												}
																																	...
																																	var11 = var39[var22];
																																	class81.intStack[++class81.intStackSize
																																			- 1] = class211.widgetSettings[var11];
																																}
																															} else {
																																class81.intStack[++class81.intStackSize
																																		- 1] = var39[var22];
																															...
																															if (var7 < 1000) {
																																if (var7 == 100) {
																																	...
																																	if (var17.children == null) {
																																		var17.children = new Widget[var16
																																				+ 1];
																																	}

																																	if (var17.children.length <= var16) {
																																		Widget[] var18 = new Widget[var16
																																				+ 1];
																																...
																																if (var7 < 1900) {
																																	...
																																	if (var7 == 1800) {
																																		...
																																		var15 = class81.intStack[--class81.intStackSize];
																																		--var15;
																																		if (var25.actions != null
																																				&& var15 < var25.actions.length
																																				&& var25.actions[var15] != null) {
																																			class81.scriptStringStack[++class81.scriptStringStackSize
																																					- 1] = var25.actions[var15];
																																		} else {
																																			class81.scriptStringStack[++class81.scriptStringStackSize
																																					- 1] = "";
																																		}
																																	...
																																	if (var7 < 3200) {
																																		if (var7 == 3100) {
																																			...
																																			class81.intStackSize -= 2;
																																			class2.method5(
																																					AbstractByteBuffer.localPlayer,
																																					class81.intStack[class81.intStackSize],
																																					class81.intStack[class81.intStackSize
																																							+ 1]);
																																			var13 = 1;
																																			...
																																			Client.secretPacketBuffer1
																																					.putOpcode(
																																							Opcodes.PACKET_CLIENT_NUMERIC_INPUT);
																																			...
																																			if (var7 == 3108) {
																																				...
																																				class81.intStack[++class81.intStackSize
																																						- 1] = class23.preferences.hideRoofs
																																								? 1
																																								: 0;
																																				var13 = 1;
																																			} else if (var7 == 3112) {
																																				...
																																				Client.secretPacketBuffer1
																																						.putOpcode(
																																								Opcodes.PACKET_CLIENT_ITEM_PRICE);
																																				if (Client.RUNELITE_PACKET) {
																																					Client.secretPacketBuffer1
																																							.runeliteWriteInt(
																																									var14);
																																				...
																																				var57 = class81.scriptStringStack[class81.scriptStringStackSize
																																						+ 1];
																																				if (var54
																																						.length() > 500) {
																																					var13 = 1;
																																			...
																																			for (var19 = 0; var19 < var16; ++var19) {
																																				...
																																				if (var20 != null
																																						&& var20 != AbstractByteBuffer.localPlayer
																																						&& var20.name != null
																																						&& var20.name
																																								.equalsIgnoreCase(
																																										var54)) {
																																					if (var14 == 1) {
																																						...
																																						Client.secretPacketBuffer1
																																								.putOpcode(
																																										Opcodes.PACKET_CLIENT_TRADE_PLAYER);
																																						if (Client.RUNELITE_PACKET) {
																																							Client.secretPacketBuffer1
																																									.runeliteWriteInt(
																																											var42[var19]);
																																		...
																																		if (var7 < 3400) {
																																			if (var7 == 3300) {
																																				...
																																				if (var7 == 3302) {
																																					...
																																					var29 = ++class81.intStackSize
																																							- 1;
																																					var32 = (ItemContainer) ItemContainer.itemContainers
																																							.get((long) var14);
																																					if (var32 == null) {
																																						var28 = 0;
																																					} else if (var15 >= 0
																																							&& var15 < var32.stackSizes.length) {
																																					...
																																					var14 = class81.intStack[--class81.intStackSize];
																																					class81.intStack[++class81.intStackSize
																																							- 1] = Client.boostedSkillLevels[var14];
																																					var13 = 1;
																																				} else if (var7 == 3306) {
																																					var14 = class81.intStack[--class81.intStackSize];
																																					class81.intStack[++class81.intStackSize
																																							- 1] = Client.realSkillLevels[var14];
																																					var13 = 1;
																																				} else if (var7 == 3307) {
																																					var14 = class81.intStack[--class81.intStackSize];
																																					class81.intStack[++class81.intStackSize
																																							- 1] = Client.skillExperiences[var14];
																																					var13 = 1;
																																				} else if (var7 == 3308) {
																																					var14 = class5.plane;
																																					var15 = (AbstractByteBuffer.localPlayer.x >> 7)
																																							+ WallObject.baseX;
																																					var16 = (AbstractByteBuffer.localPlayer.y >> 7)
																																							+ Varcs.baseY;
																																					class81.intStack[++class81.intStackSize
																																							- 1] = (var15 << 14)
																																									+ var16
																																					...
																																					if (var7 == 3316) {
																																						...
																																						var16 = class81.intStack[class81.intStackSize
																																								+ 2];
																																						var29 = class81.intStack[class81.intStackSize
																																								+ 3];
																																						var14 += var15 << 14;
																																						var14 += var16 << 28;
																																						var14 += var29;
																																			...
																																			if (var7 == 3600) {
																																				...
																																				var14 = class81.intStack[--class81.intStackSize];
																																				if (Client.field1180 == 2
																																						&& var14 < Client.friendCount) {
																																					class81.scriptStringStack[++class81.scriptStringStackSize
																																							- 1] = Client.friends[var14].name;
																																					class81.scriptStringStack[++class81.scriptStringStackSize
																																							- 1] = Client.friends[var14].previousName;
																																				} else {
																																					class81.scriptStringStack[++class81.scriptStringStackSize
																																							- 1] = "";
																																					class81.scriptStringStack[++class81.scriptStringStackSize
																																				...
																																				if (var7 == 3606) {
																																							...
																																							for (var16 = 0; var16 < Client.friendCount; ++var16) {
																																								...
																																								if (var71) {
																																									...
																																									for (var21 = var16; var21 < Client.friendCount; ++var21) {
																																										Client.friends[var21] = Client.friends[var21
																																												+ 1];
																																									}
																																									...
																																									Client.secretPacketBuffer1
																																											.putOpcode(
																																													Opcodes.PACKET_CLIENT_DELETE_FRIEND);
																																									Client.secretPacketBuffer1
																																											.putByte(
																																													class162.getLength(
																																															var55));
																																					...
																																					if (var7 == 3607) {
																																								...
																																								if (var54 != null) {
																																									...
																																									label1553: while (true) {
																																										if (var16 >= Client.ignoreCount) {
																																											...
																																											if (class207
																																													.method3989(
																																															AbstractByteBuffer.localPlayer.name,
																																															class5.field42)
																																													.equals(var54)) {
																																												MessageNode
																																														.sendGameMessage(
																																												...
																																												Client.secretPacketBuffer1
																																														.putOpcode(
																																																Opcodes.PACKET_CLIENT_ADD_IGNORE);
																																												Client.secretPacketBuffer1
																																														.putByte(
																																																class162.getLength(
																																																		var55));
																																										...
																																										if (var48 != null
																																											...
																																											MessageNode
																																													.sendGameMessage(
																																															31,
																																															"",
																																															var55 + " is already on your ignore list");
																																											break;
																																										}
																																								...
																																								for (var16 = 0; var16 < Client.ignoreCount; ++var16) {
																																									...
																																									if (var71) {
																																										...
																																										for (var21 = var16; var21 < Client.ignoreCount; ++var21) {
																																											Client.ignores[var21] = Client.ignores[var21
																																													+ 1];
																																										}
																																										...
																																										Client.secretPacketBuffer1
																																												.putOpcode(
																																														Opcodes.PACKET_CLIENT_DELETE_IGNORE);
																																										Client.secretPacketBuffer1
																																												.putByte(
																																														class162.getLength(
																																																var55));
																																						...
																																						var14 = class81.intStack[--class81.intStackSize];
																																						if (Client.clanChatOwner != null
																																								&& var14 < class21.clanChatCount) {
																																							class81.scriptStringStack[++class81.scriptStringStackSize
																																									- 1] = WorldMapType1.clanMembers[var14].username;
																																						} else {
																																							class81.scriptStringStack[++class81.scriptStringStackSize
																																									- 1] = "";
																																						}
																																						...
																																						if (Client.clanChatOwner != null
																																								&& var14 < class21.clanChatCount) {
																																							class81.intStack[++class81.intStackSize
																																									- 1] = WorldMapType1.clanMembers[var14].world;
																																						} else {
																																							class81.intStack[++class81.intStackSize
																																									- 1] = 0;
																																						}
																																						...
																																						if (Client.clanChatOwner != null
																																								&& var14 < class21.clanChatCount) {
																																							class81.intStack[++class81.intStackSize
																																									- 1] = WorldMapType1.clanMembers[var14].rank;
																																						} else {
																																							class81.intStack[++class81.intStackSize
																																									- 1] = 0;
																																						}
																																						...
																																						if (!var55
																																							...
																																							Client.secretPacketBuffer1
																																									.putOpcode(
																																											Opcodes.PACKET_CLIENT_JOIN_CLANCHAT);
																																							Client.secretPacketBuffer1
																																									.putByte(
																																											class162.getLength(
																																													var55));
																																						...
																																						var14 = class81.intStack[--class81.intStackSize];
																																						if (Client.field1180 != 0
																																								&& var14 < Client.ignoreCount) {
																																							class81.scriptStringStack[++class81.scriptStringStackSize
																																									- 1] = Client.ignores[var14].name;
																																							class81.scriptStringStack[++class81.scriptStringStackSize
																																									- 1] = Client.ignores[var14].previousName;
																																						} else {
																																							class81.scriptStringStack[++class81.scriptStringStackSize
																																									- 1] = "";
																																							class81.scriptStringStack[++class81.scriptStringStackSize
																																						...
																																						if (WorldMapType1.clanMembers != null
																																								&& var14 < class21.clanChatCount
																																								&& WorldMapType1.clanMembers[var14].username
																																										.equalsIgnoreCase(
																																												AbstractByteBuffer.localPlayer.name)) {
																																							class81.intStack[++class81.intStackSize
																																									- 1] = 1;
																																			...
																																			if (var7 == 4200) {
																																				...
																																				if (var7 == 4201) {
																																					...
																																					if (var15 >= 1
																																							&& var15 <= 5
																																							&& var62.groundActions[var15
																																									- 1] != null) {
																																						class81.scriptStringStack[++class81.scriptStringStackSize
																																								- 1] = var62.groundActions[var15
																																										- 1];
																																					} else {
																																						class81.scriptStringStack[++class81.scriptStringStackSize
																																								- 1] = "";
																																					...
																																					if (var15 >= 1
																																							&& var15 <= 5
																																							&& var62.inventoryActions[var15
																																									- 1] != null) {
																																						class81.scriptStringStack[++class81.scriptStringStackSize
																																								- 1] = var62.inventoryActions[var15
																																										- 1];
																																					} else {
																																						class81.scriptStringStack[++class81.scriptStringStackSize
																																								- 1] = "";
																																					...
																																					if (var7 == 4205) {
																																						...
																																						if (class33.field491 != null
																																								&& ScriptVarType.field101 < class25.field370) {
																																							class81.intStack[++class81.intStackSize
																																									- 1] = class33.field491[++ScriptVarType.field101
																																											- 1]
																																											& '\uffff';
																																						} else {
																																							class81.intStack[++class81.intStackSize
																																			...
																																			if (var7 == 5306) {
																																				...
																																				class81.intStack[++class81.intStackSize
																																						- 1] = class23.preferences.screenType;
																																				var13 = 1;
																																			} else if (var7 != 5309) {
																																				var13 = 2;
																																			} else {
	...
	public static boolean method1190(class219 var0) {
		return class219.field2806 == var0 || class219.field2797 == var0 || class219.field2798 == var0
				|| class219.field2799 == var0 || class219.field2800 == var0 || class219.field2804 == var0
				|| class219.field2802 == var0 || class219.field2803 == var0;
	}

	static final int method1189(int var0, int var1) {
		int var2 = Varcs.getSmoothNoise(var0 + '넵', var1 + 91923, 4) - 128
				+ (Varcs.getSmoothNoise(var0 + 10294, var1 + '鎽', 2) - 128 >> 1)
				+ (Varcs.getSmoothNoise(var0, var1, 1) - 128 >> 2);
