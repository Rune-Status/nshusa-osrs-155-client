public class class236 implements Runnable {
	...
	static void method4311(int var0) {
		if (var0 == -3) {
			...
			class1.method3("Your account has not logged out from its last",
			...
			class1.method3("You need a members account to login to this world.",
			...
			class1.method3("You are standing in a members-only area.",
					"To play on this world move to a free area first", "");
		} else if (var0 == 18) {
			class1.method3("Account locked as we suspect it has been stolen.",
					"Press \'recover a locked account\' on front page.", "");
		} else if (var0 == 19) {
			class1.method3("This world is running a closed Beta.", "Sorry invited players only.",
			...
			class1.method3("Your account must have a displayname set", "in order to play the game.  Please set it",
					"via the website, or the main game.");
		} else if (var0 == 32) {
			class1.method3("Your attempt to log into your account was", "unsuccessful.  Don\'t worry, you can sort",
			...
			class1.method3("Sorry, but your account is not eligible to", "play this version of the game.  Please try",
