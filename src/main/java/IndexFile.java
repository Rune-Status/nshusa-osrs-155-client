...
public final class IndexFile {
					...
					if (var7 < var3) {
						label146: {
							...
							if (var4) {
								...
								var9 = ((field2286[5] & 255) << 8) + ((field2286[4] & 255) << 16)
										+ (field2286[6] & 255);
			...
			while (true) {
				...
				while (!var8) {
					...
					if (var13 > 0 && var14 > 0 && var13 < 103 && var14 < 103) {
						...
						if (var12 != 22 || !Client.lowMemory || var15.field3439 != 0 || var15.interactType == 1
								|| var15.field3476) {
							if (!var15.method4619()) {
								++Client.field980;
								var3 = false;
	...
	static char method3103(char var0) {
		return (char) (var0 == 198 ? 'E'
				: (var0 == 230 ? 'e' : (var0 == 223 ? 's' : (var0 == 338 ? 'E' : (var0 == 339 ? 'e' : '\u0000')))));
	}
}
