...
public class AbstractSoundSystem {
	...
	public static File method2129(String var0, String var1, int var2) {
		...
		if (var4 == null && var2 == 0) {
			label121: for (int var15 = 0; var15 < class72.field879.length; ++var15) {
				for (int var16 = 0; var16 < class17.cacheLocations.length; ++var16) {
					File var17 = new File(class17.cacheLocations[var16] + class72.field879[var15] + File.separatorChar
		...
		if (var4 == null) {
			var4 = class89.userHome + File.separatorChar + "jagexcache" + var3 + File.separatorChar + var0
