				...
				if (var0 == 5003) {
					...
					if (var20 != null) {
						...
						class81.scriptStringStack[++class81.scriptStringStackSize - 1] = var20.name != null ? var20.name
								: "";
						class81.scriptStringStack[++class81.scriptStringStackSize - 1] = var20.sender != null
								? var20.sender
								: "";
						class81.scriptStringStack[++class81.scriptStringStackSize - 1] = var20.value != null
								? var20.value
								: "";
					} else {
					...
					if (var22 != null) {
						...
						class81.scriptStringStack[++class81.scriptStringStackSize - 1] = var22.name != null ? var22.name
								: "";
						class81.scriptStringStack[++class81.scriptStringStackSize - 1] = var22.sender != null
								? var22.sender
								: "";
						class81.scriptStringStack[++class81.scriptStringStackSize - 1] = var22.value != null
								? var22.value
								: "";
					} else {
						class81.intStack[++class81.intStackSize - 1] = -1;
					...
					if (var0 == 5016) {
						...
						if (var0 == 5017) {
							...
							Client.field1131 = class81.scriptStringStack[--class81.scriptStringStackSize].toLowerCase()
									.trim();
							return 1;
						} else if (var0 == 5022) {
