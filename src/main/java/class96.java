					...
					if (Client.loadingStage == 45) {
						...
						if (Client.loadingStage == 60) {
							...
							if (!class8.indexTextures.method4292()) {
								...
								TextureProvider var32 = new TextureProvider(class8.indexTextures, class37.indexSprites,
							...
							if (!ClanMember.field918.method4292()) {
								...
								class90.loadingText = "Loading interfaces - "
										+ (80 + class51.indexScripts.method4322() / 6) + "%";
								class90.loadingBarPercentage = 96;
							} else if (!class31.field458.method4292()) {
								class90.loadingText = "Loading interfaces - "
										+ (96 + class31.field458.method4322() / 50) + "%";
								class90.loadingBarPercentage = 96;
							} else {
							...
							if (!class41.indexWorldMap.method4288(class40.field561.field559)) {
								class90.loadingText = "Loading world map - "
										+ class41.indexWorldMap.method4241(class40.field561.field559) / 10 + "%";
							} else {
								if (GameObject.renderOverview == null) {
									GameObject.renderOverview = new RenderOverview();
									GameObject.renderOverview.method5317(class41.indexWorldMap, Friend.field827,
											Client.field932, class288.field3819);
								}
