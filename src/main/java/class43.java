	...
	static final void drawDot(int var0, int var1, int var2, int var3, SpritePixels var4, class210 var5) {
		if (var4 != null) {
			...
			if (var7 <= 6400) {
				...
				if (var7 > 2500) {
					var4.method5185(var10 + var5.field2615 / 2 - var4.maxWidth / 2,
							var5.field2611 / 2 - var11 - var4.maxHeight / 2, var0, var1, var5.field2615, var5.field2611,
							var5.field2616, var5.field2613);
				} else {
					var4.method5172(var0 + var10 + var5.field2615 / 2 - var4.maxWidth / 2,
							var5.field2611 / 2 + var1 - var11 - var4.maxHeight / 2);
				}
