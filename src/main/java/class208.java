public class class208 extends class117 {
	...
	protected void vmethod4004(int[] var1, int var2, int var3) {
		...
		for (class205 var6 = (class205) this.field2601.getFront(); var6 != null; var6 = (class205) this.field2601
				.getNext()) {
	...
	protected void vmethod4023(int var1) {
		...
		for (class205 var3 = (class205) this.field2601.getFront(); var3 != null; var3 = (class205) this.field2601
				.getNext()) {
		...
		if ((this.field2600.field2539[var1.field2563] & 4) != 0 && var1.field2571 < 0) {
			...
			if (var4 <= var2) {
				if (this.field2600.field2540[var1.field2563] == 0) {
					var1.field2570 = class115.method2352(var1.field2559, var1.field2570.method2248(),
							var1.field2570.method2350(), var1.field2570.method2251());
				} else {
					var1.field2570 = class115.method2352(var1.field2559, var1.field2570.method2248(), 0,
							var1.field2570.method2251());
	...
	void method4000(class205 var1, int[] var2, int var3, int var4, int var5) {
		if ((this.field2600.field2539[var1.field2563] & 4) != 0 && var1.field2571 < 0) {
			...
			while (true) {
				...
				if (this.field2600.field2540[var1.field2563] == 0) {
					var1.field2570 = class115.method2352(var1.field2559, var10.method2248(), var10.method2350(),
							var10.method2251());
				} else {
