public class GrandExchangeOffer {
	...
	static final void method100(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null
					&& (!var9.hasScript || var9.type == 0 || var9.field2785 || class244.getWidgetConfig(var9) != 0
							|| var9 == Client.field1047 || var9.contentType == 1338)
					&& var9.parentId == var1 && (!var9.hasScript || !Script.method1926(var9))) {
				...
				if (!var9.hasScript || var12 < var14 && var13 < var15) {
					...
					if (var9.contentType == 1337) {
						if (!Client.field1123 && !Client.isMenuOpen && var43) {
							...
							for (var46 = 0; var46 < class132.field1989; ++var46) {
								...
								if (var22 != var20) {
									var20 = var22;
									if (var25 == 2
											&& class8.region.method2801(class5.plane, var23, var24, var22) >= 0) {
										...
										if (Client.itemSelectionState == 1) {
											class10.addMenuEntry(
													"Use", Client.field1067 + " " + "->" + " "
															+ class60.getColTags('\uffff') + var27.name,
													1, var22, var23, var24);
										} else if (Client.spellSelected) {
											if ((WorldMapType1.field451 & 4) == 4) {
												class10.addMenuEntry(Client.field1071,
														Client.field948 + " " + "->" + " "
																+ class60.getColTags('\uffff') + var27.name,
														2, var22, var23, var24);
											}
											...
											if (var36 != null) {
												for (int var37 = 4; var37 >= 0; --var37) {
													if (var36[var37] != null) {
														...
														class10.addMenuEntry(var36[var37],
																class60.getColTags('\uffff') + var27.name, var38, var22,
																var23, var24);
													}
												}
											}

											class10.addMenuEntry("Examine", class60.getColTags('\uffff') + var27.name,
													1002, var27.id << 14, var23, var24);
										}
									}
									...
									if (var25 == 1) {
										...
										if (var47.composition.field3559 == 1 && (var47.x & 127) == 64
												&& (var47.y & 127) == 64) {
											for (var28 = 0; var28 < Client.field960; ++var28) {
												var29 = Client.cachedNPCs[Client.npcIndices[var28]];
												if (var29 != null && var47 != var29 && var29.composition.field3559 == 1
														&& var47.x == var29.x && var29.y == var47.y) {
													SoundTask.method2153(var29.composition, Client.npcIndices[var28],
															var23, var24);
												}
											}
									...
									if (var25 == 0) {
										...
										if ((var48.x & 127) == 64 && (var48.y & 127) == 64) {
											for (var28 = 0; var28 < Client.field960; ++var28) {
												var29 = Client.cachedNPCs[Client.npcIndices[var28]];
												if (var29 != null && var29.composition.field3559 == 1
														&& var48.x == var29.x && var29.y == var48.y) {
													SoundTask.method2153(var29.composition, Client.npcIndices[var28],
															var23, var24);
												}
											}
											...
											for (var54 = 0; var54 < var28; ++var54) {
												var39 = Client.cachedPlayers[var50[var54]];
												if (var39 != null && var48 != var39 && var48.x == var39.x
														&& var48.y == var39.y) {
													ItemContainer.method1130(var39, var50[var54], var23, var24);
												}
											}
									...
									if (var25 == 3) {
										...
										if (var49 != null) {
											for (Item var53 = (Item) var49
													.getTail(); var53 != null; var53 = (Item) var49.getPrevious()) {
												ItemComposition var51 = class46.getItemDefinition(var53.id);
												if (Client.itemSelectionState == 1) {
													class10.addMenuEntry("Use",
															Client.field1067 + " " + "->" + " "
																	+ class60.getColTags(16748608) + var51.name,
															16, var53.id, var23, var24);
												} else if (Client.spellSelected) {
													if ((WorldMapType1.field451 & 1) == 1) {
														class10.addMenuEntry(Client.field1071,
																Client.field948 + " " + "->" + " "
																		+ class60.getColTags(16748608) + var51.name,
																17, var53.id, var23, var24);
													}
												} else {
													...
													for (int var31 = 4; var31 >= 0; --var31) {
														if (var30 != null && var30[var31] != null) {
															...
															class10.addMenuEntry(var30[var31],
																	class60.getColTags(16748608) + var51.name, var32,
																	var53.id, var23, var24);
														} else if (var31 == 2) {
															class10.addMenuEntry("Take",
																	class60.getColTags(16748608) + var51.name, 20,
																	var53.id, var23, var24);
														}
													}

													class10.addMenuEntry("Examine",
															class60.getColTags(16748608) + var51.name, 1004, var53.id,
															var23, var24);
												}
											}
										}
						...
						if (var9.contentType == 1400) {
							GameObject.renderOverview.method5422(MouseInput.field745, MouseInput.field746, var43, var10,
									var11, var9.width, var9.height);
						}

						if (!Client.isMenuOpen && var43) {
							if (var9.contentType == 1400) {
								GameObject.renderOverview.method5366(var10, var11, var9.width, var9.height, var16,
										var17);
							} else {
						...
						if (var9.type == 0) {
							...
							method100(var0, var9.id, var12, var13, var14, var15, var10 - var9.scrollX,
									var11 - var9.scrollY);
							if (var9.children != null) {
								method100(var9.children, var9.id, var12, var13, var14, var15, var10 - var9.scrollX,
										var11 - var9.scrollY);
							}

							WidgetNode var34 = (WidgetNode) Client.componentTable.get((long) var9.id);
							if (var34 != null) {
								if (var34.owner == 0 && MouseInput.field745 >= var12 && MouseInput.field746 >= var13
										&& MouseInput.field745 < var14 && MouseInput.field746 < var15
										&& !Client.isMenuOpen && !Client.field961) {
									for (ScriptEvent var35 = (ScriptEvent) Client.field1112
											.getFront(); var35 != null; var35 = (ScriptEvent) Client.field1112
													.getNext()) {
										if (var35.field845) {
											var35.unlink();
						...
						if (var9.hasScript) {
							ScriptEvent var52;
							if (!var9.field2791) {
								if (var9.field2792 && MouseInput.field745 >= var12 && MouseInput.field746 >= var13
										&& MouseInput.field745 < var14 && MouseInput.field746 < var15) {
									for (var52 = (ScriptEvent) Client.field1112
											.getFront(); var52 != null; var52 = (ScriptEvent) Client.field1112
													.getNext()) {
							...
							} else if (MouseInput.field745 >= var12 && MouseInput.field746 >= var13
									&& MouseInput.field745 < var14 && MouseInput.field746 < var15) {
								for (var52 = (ScriptEvent) Client.field1112
										.getFront(); var52 != null; var52 = (ScriptEvent) Client.field1112.getNext()) {
									if (var52.field845) {
										var52.unlink();
							...
							if (MouseInput.field745 >= var12 && MouseInput.field746 >= var13
									&& MouseInput.field745 < var14 && MouseInput.field746 < var15) {
								var43 = true;
							} else {
								var43 = false;
							...
							if ((MouseInput.field741 == 1 || !class110.field1650 && MouseInput.field741 == 4)
									&& MouseInput.field752 >= var12 && MouseInput.field753 >= var13
									&& MouseInput.field752 < var14 && MouseInput.field753 < var15) {
								var45 = true;
							}
							...
							if (var9.contentType == 1400) {
								GameObject.renderOverview.method5369(MouseInput.field745, MouseInput.field746,
										var43 & var44, var43 & var45);
							}
							...
							if (var9.field2785) {
								...
								if (var9.configListenerArgs != null && Client.field1100 > var9.field2762) {
									if (var9.configTriggers != null && Client.field1100 - var9.field2762 <= 32) {
										label1093: for (var46 = var9.field2762; var46 < Client.field1100; ++var46) {
								...
								if (var9.tableListenerArgs != null && Client.field1102 > var9.field2711) {
									if (var9.tableModTriggers != null && Client.field1102 - var9.field2711 <= 32) {
										label1069: for (var46 = var9.field2711; var46 < Client.field1102; ++var46) {
								...
								if (var9.skillListenerArgs != null && Client.field1104 > var9.field2718) {
									if (var9.skillTriggers != null && Client.field1104 - var9.field2718 <= 32) {
										label1045: for (var46 = var9.field2718; var46 < Client.field1104; ++var46) {
						...
						if (!var9.hasScript && Client.field1052 == null && ClanMember.field915 == null
								&& !Client.isMenuOpen) {
							if ((var9.field2740 >= 0 || var9.field2685 != 0) && MouseInput.field745 >= var12
									&& MouseInput.field746 >= var13 && MouseInput.field745 < var14
									&& MouseInput.field746 < var15) {
								if (var9.field2740 >= 0) {
							...
							if (var9.type == 8 && MouseInput.field745 >= var12 && MouseInput.field746 >= var13
									&& MouseInput.field745 < var14 && MouseInput.field746 < var15) {
								class48.field635 = var9;
							}

							if (var9.scrollHeight > var9.height) {
								class22.method154(var9, var10 + var9.width, var11, var9.height, var9.scrollHeight,
										MouseInput.field745, MouseInput.field746);
							}
						}
					}
				}
