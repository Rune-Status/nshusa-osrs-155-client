...
public class CombatInfoListHolder extends Node {
	...
	void method1737(int var1, int var2, int var3, int var4) {
		...
		for (CombatInfo1 var7 = (CombatInfo1) this.combatInfo1
				.method3664(); var7 != null; var7 = (CombatInfo1) this.combatInfo1.method3665()) {
			++var6;
	...
	CombatInfo1 method1738(int var1) {
		...
		if (var2 != null && var2.field1271 <= var1) {
			for (CombatInfo1 var3 = (CombatInfo1) this.combatInfo1.method3665(); var3 != null
					&& var3.field1271 <= var1; var3 = (CombatInfo1) this.combatInfo1.method3665()) {
				var2.unlink();
				var2 = var3;
			}
	...
	static void method1746() {
		...
		if (class90.username.length() == 0) {
			class1.method3("Please enter your username.", "If you created your account after November",
			...
			if (0L == var1) {
				...
				try {
					...
					var15.write("data2=" + CollisionData.method3130(var12) + "&dest="
							+ CollisionData.method3130("passwordchoice.ws"));
					var15.flush();
			...
			case 3:
				...
				break;
			case 4:
				class1.method3("The part of the website you are trying", "to connect to is offline at the moment.",
						"Please try again later.");
				break;
			case 5:
				class1.method3("Sorry, there was an error trying to", "log you in to this part of the website.",
						"Please try again later.");
				break;
			case 6:
				class1.method3("", "Error connecting to server.", "");
				break;
			case 7:
				class1.method3("You must enter a valid login to proceed. For accounts",
