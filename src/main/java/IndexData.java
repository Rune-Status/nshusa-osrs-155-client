...
public class IndexData extends IndexDataBase {
	...
	void vmethod4340(int var1) {
		if (this.field3244 != null && this.field3241 != null && this.field3241[var1]) {
			...
			synchronized (class236.field3237) {
				for (FileSystem var6 = (FileSystem) class236.field3237
						.getFront(); var6 != null; var6 = (FileSystem) class236.field3237.getNext()) {
	...
	int vmethod4321(int var1) {
		return super.field3221[var1] != null ? 100
				: (this.field3241[var1] ? 100 : class225.method4197(this.index, var1));
	}
	...
	void setInformation(int var1, int var2) {
		...
		if (this.field3240 != null) {
			...
			synchronized (class236.field3237) {
				for (FileSystem var8 = (FileSystem) class236.field3237
						.getFront(); var8 != null; var8 = (FileSystem) class236.field3237.getNext()) {
