		...
		for (var2 = 0; var2 < 4; ++var2) {
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					...
					var20 = (var42[var12 - 1][var11] >> 2) + (var42[var12][var11 - 1] >> 2)
							+ (var42[var12 + 1][var11] >> 3) + (var42[var12][var11 + 1] >> 3)
							+ (var42[var12][var11] >> 1);
				...
				if (var11 >= 1 && var11 < 103) {
					...
					for (var17 = -5; var17 < 109; ++var17) {
						...
						if (var17 >= 1 && var17 < 103
								&& (!Client.lowMemory || (class61.tileSettings[0][var11][var17] & 2) != 0
										|| (class61.tileSettings[var2][var11][var17] & 16) == 0)) {
							...
							if (var20 > 0 || var21 > 0) {
								...
								if (var21 == 0) {
									var0.addTile(var2, var11, var17, 0, 0, -1, var22, var23, var24, var25,
											class147.method2980(var30, var26), class147.method2980(var30, var27),
											class147.method2980(var30, var28), class147.method2980(var30, var29), 0, 0,
											0, 0, var32, 0);
								} else {
									...
									var0.addTile(var2, var11, var17, var33, var48, var36, var22, var23, var24, var25,
											class147.method2980(var30, var26), class147.method2980(var30, var27),
											class147.method2980(var30, var28), class147.method2980(var30, var29),
											ChatLineBuffer.adjustHSLListness0(var37, var26),
											ChatLineBuffer.adjustHSLListness0(var37, var27),
											ChatLineBuffer.adjustHSLListness0(var37, var28),
											ChatLineBuffer.adjustHSLListness0(var37, var29), var32, var39);
								}
							}
						}
					}
				...
				for (int var7 = 0; var7 <= 104; ++var7) {
					for (int var8 = 0; var8 <= 104; ++var8) {
						...
						if ((class168.field2350[var6][var8][var7] & var2) != 0) {
							...
							for (var12 = var6; var9 > 0
									&& (class168.field2350[var6][var8][var9 - 1] & var2) != 0; --var9) {
								;
							}
							...
							if (var13 >= 8) {
								...
								Region.addOcclude(var5, 1, var8 * 128, var8 * 128, var9 * 128, var10 * 128 + 128, var15,
										var16);
						...
						if ((class168.field2350[var6][var8][var7] & var3) != 0) {
							...
							for (var12 = var6; var9 > 0
									&& (class168.field2350[var6][var9 - 1][var7] & var3) != 0; --var9) {
								;
							}
							...
							if (var13 >= 8) {
								...
								Region.addOcclude(var5, 2, var9 * 128, var10 * 128 + 128, var7 * 128, var7 * 128, var15,
										var16);
						...
						if ((class168.field2350[var6][var8][var7] & var4) != 0) {
							...
							for (var12 = var7; var11 > 0
									&& (class168.field2350[var6][var8][var11 - 1] & var4) != 0; --var11) {
								;
							}
							...
							if ((var10 - var9 + 1) * (var12 - var11 + 1) >= 4) {
								...
								Region.addOcclude(var5, 4, var9 * 128, var10 * 128 + 128, var11 * 128,
